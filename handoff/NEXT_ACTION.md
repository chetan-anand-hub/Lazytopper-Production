...
# Base SHA: ad2a9b2  (squash of #445; re-derive after this docs PR merges — never trust a written SHA. #445's pre-flight caught a handoff written against a tip FOUR commits stale AND a shared checkout that was too.)
