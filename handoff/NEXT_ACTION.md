...
SHA: f83915b
Last PRs: #249 ("Finish session" scorecard trigger; → `704dcff`) + #250 (docs) + #251 (AI-tier PR1 mechanical content-integrity; → `f4a41b6`) + #252 (docs) + #253 (AI-tier PR1b pack-file 5-mark retags; → `f83915b`)

## ⏭️ IMMEDIATE NEXT — AI-tier PR2 (provenance + ranking) → [FU-AITIER-MARKS-MISMATCH] content pass → (iii) gated-spelling → (2) MI eval → (3) Stage 3 → Fix B
...
**AI-tier PR1b pack retags (#253 — DONE, trunk `f83915b`, 12 relabelled / 7 quarantined / backlog 19→7,
[FU-AITIER-PACK-5MK-SHORT] RESOLVED)** are done. The items below are **QUEUED but NOT yet authorized** — the owner sends each as
its own instruction, branched fresh from `f83915b`. Do not start until instructed.

- **(NEXT) AI-tier PR2 — provenance + ranking (architectural).** From the audit §6(a): add a `source`/provenance stamp at the
