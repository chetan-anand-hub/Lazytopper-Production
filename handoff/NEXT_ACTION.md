...
## ⏭️ CURRENT POINTER (as of 2026-07-12 — trunk `5bd148c`, #380)
...
> - **IMMEDIATE NEXT (owner-picked):** the CT fast-follows are DONE (#380). Remaining: (1) **Bank extraction / expansion** — a bank-expansion batch is in flight (PR #381, band-scarcity floor); Pass-2 Content-folder audit; case-based is a Fable AUTHORING lane (Z3), not extraction. (2) The **Full Mock rebuild** is next on the surface critical path (reuses the CT scorecard-and-sheet + upload-grade + the new section/concept lens pattern). (3) **Me/Progress redesign** (arc PR-4).
