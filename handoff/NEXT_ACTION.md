...
SHA: 775ee75
Last PRs: #255 (AI-tier PR2a source-provenance stamp + soft AI-lower ranking; → `686f737`) + #256 (docs) + #257 (AI-tier PR2b strip fabricated `pastBoardYear`; → `d6e0e14`) + #258 (docs) + #259 (AI-tier FU-RANK-MOCKS-HPQ soft AI-demotion on Full Mock + Topic Mock; → `775ee75`)

## ⏭️ IMMEDIATE NEXT — [FU-AITIER-MARKS-MISMATCH] content pass → [FU-AITIER-RANK-DIFFICULTY-HELPERS] → (iii) gated-spelling → (2) MI eval → (3) Stage 3 → Fix B
