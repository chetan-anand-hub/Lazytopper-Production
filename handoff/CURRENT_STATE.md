...
SHA: d6e0e14
Last merged PRs: **#253 (AI-tier PR1b pack-file 5-mark retags; squash → `f83915b`)**, **#254 (docs)**, **#255 (AI-tier PR2a source-provenance stamp + soft AI-lower ranking; squash → `686f737`)**, **#256 (docs)**, **#257 (AI-tier PR2b strip fabricated `pastBoardYear`; squash → `d6e0e14`)**
