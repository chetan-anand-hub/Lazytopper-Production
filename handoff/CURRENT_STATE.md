...
SHA: f4a41b6
Last merged PRs: **#246 (Check & Improve detect-then-confirm + question photo upload; squash → `c9404e1`)**, **#248 (docs)**, **#249 ("Finish session" scorecard trigger; squash → `704dcff`)**, **#250 (docs)**, **#251 (AI-tier PR1 mechanical content-integrity; squash → `f4a41b6`)**
