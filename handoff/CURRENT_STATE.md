...
SHA: 704dcff
Last merged PRs: **#244 (Check & Improve auto-detect — Claim 2; squash → `43ffa09`)**, **#245 (docs)**, **#246 (Check & Improve detect-then-confirm + question photo upload; squash → `c9404e1`)**, **#248 (docs)**, **#249 ("Finish session" scorecard trigger; squash → `704dcff`)**
