...
SHA: 83b1268  (trunk tip — #330 Light extraction pilot merged; latest PRODUCT commit)
Last merged PRs: **#330 (Light extraction pilot — bank 326→767, 35 bound figures, ship-tracked review queue)**, #332 (docs post-#331), #331 (grading-path bugs: C&I grade-wipe + progress-sync auth + grader ECF).
