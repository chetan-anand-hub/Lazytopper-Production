...
SHA: f83915b
Last merged PRs: **#249 ("Finish session" scorecard trigger; squash → `704dcff`)**, **#250 (docs)**, **#251 (AI-tier PR1 mechanical content-integrity; squash → `f4a41b6`)**, **#252 (docs)**, **#253 (AI-tier PR1b pack-file 5-mark retags; squash → `f83915b`)**
