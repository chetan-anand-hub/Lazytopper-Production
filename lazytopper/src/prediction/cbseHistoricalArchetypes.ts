...
export const CBSE_HISTORICAL_ARCHETYPES: CbseArchetypeEntry[] = [
  ...
  m("Surface Areas and Volumes", "Frustum", 2, "Short", "Applying", "procedural", 2019),
  ...
  m("Surface Areas and Volumes", "Frustum", 1, "MCQ", "Applying", "procedural", 2023),
  ...
  m("Statistics", "Graph/Ogive", 5, "Long", "Applying", "diagram", 2019),
  ...
  m("Statistics", "Graph/Ogive", 4, "Case-Based", "Analysing", "case-based", 2023),
  ...
  m("Statistics", "Graph/Ogive", 4, "Case-Based", "Analysing", "case-based", 2024),
