...
import { RN2_PACK2 } from './questionBanks/class10/maths/realNumbers.pack2';
import { PL2_PACK2 } from './questionBanks/class10/maths/polynomials.pack2';
import { PLE2_PACK2 } from './questionBanks/class10/maths/pairOfLinearEquations.pack2';
import { QE2_PACK2 } from './questionBanks/class10/maths/quadraticEquations.pack2';
import { AP2_PACK2 } from './questionBanks/class10/maths/arithmeticProgression.pack2';
import { TR3_PACK3 } from './questionBanks/class10/maths/triangles.pack3';
import { CG2_PACK2 } from './questionBanks/class10/maths/coordinateGeometry.pack2';
import { TG3_PACK3 } from './questionBanks/class10/maths/trigonometry.pack3';
import { CI2_PACK2 } from './questionBanks/class10/maths/circles.pack2';
import { ARC2_PACK2 } from './questionBanks/class10/maths/areasRelatedToCircles.pack2';
import { SAV2_PACK2 } from './questionBanks/class10/maths/surfaceAreasVolumes.pack2';
import { ST2_PACK2 } from './questionBanks/class10/maths/statistics.pack2';
import { PR2_PACK2 } from './questionBanks/class10/maths/probability.pack2';

import { CR2_PACK2 } from './questionBanks/class10/science/chemicalReactions.pack2';
import { ABS2_PACK2 } from './questionBanks/class10/science/acidsBasesSalts.pack2';
...
// ===== P4 PYQ 2024 SCIENCE PACK (CBSE 2023-24 board exam) =====
// 6 text-extractable QPs (31/4/x, 31/5/x); 9 scanned QPs (31/1/x, 31/2/x, 31/3/x) skipped — require OCR
// Paper structure: traditional A/B/C/D/E by question type
...
import { carbonCompoundsPYQ2024 } from './questionBanks/class10/science/carbonCompounds.pyq2024';
...
import { lightReflectionPYQ2024 } from './questionBanks/class10/science/lightReflection.pyq2024';
...
export const RAW_CANONICAL_QUESTION_BANK: CanonicalQuestion[] = [
  ...
  // P4 Science PYQ 2024 — CBSE 2023-24 board papers (76 Qs across 13 Science topic files, 2026-05-25)
  // Only 31/4/x and 31/5/x are text-extractable; 31/1-3/x are scanned. 2026-27 banned topics filtered.
  ...chemicalReactionsPYQ2024,
  ...acidsBasesSaltsPYQ2024,
  ...metalsNonMetalsPYQ2024,
  ...carbonCompoundsPYQ2024,
  ...lifeProcessesPYQ2024,
  ...controlCoordinationPYQ2024,
...
const CLASS_B_STEPPED_SOLUTION_IDS: readonly string[] = [
  "AP-N-EXEM-5-LA-002", "APQ-M-SAV-006", "APQ-M-SAV-009", "APQ-M-STAT-004", "APQ-M-STAT-008", "APQ-M-TRI-007",
  "APQ-M-TRI-008", "APQ-M-TRIG-009", "APQ-S-ACID-006", "APQ-S-CARB-001", "APQ-S-CARB-003", "APQ-S-CARB-004",
  "APQ-S-CTRL-005", "APQ-S-EYE-002", "APQ-S-EYE-003", "APQ-S-EYE-005", "APQ-S-EYE-006", "APQ-S-HERED-004",
  "APQ-S-LIFE-012", "APQ-S-LIFE-013", "APQ-S-REPR-003", "ARC-H04", "ARC-H05", "ARC-H09",
  "ARC-H10", "ARC-N-EXEM-11-LA-001", "ARC-N-EXEM-11-LA-002", "ARC-N-NCERT-11-LA-001", "ARC2-016", "BX-TRI-PF-005",
  "CC-D04", "CC-H01", "CG-N-NCERT-7-EX-029", "CG2-039", "CIRC-N-EXEM-10-LA-001", "CR-H07",
  "ELEC-EXMPLR-11-LA-010", "ELEC-NCERT-11-LA-009", "ELEC-NCERT-11-LA-010", "LT-H06", "ME2-043", "MNM-D03",
  "MNM-H01", "OE2-033", "OESE-005", "OESE-009", "OESE-013", "OESE-014",
  "OESE-019", "OESE-020", "OESE-021", "OESE-022", "OESE-023", "OESE-024",
  "OESE-026", "PL2-027", "PL2-028", "PLE-M08", "POLY-H07-R", "POLY-ND01",
  "PROB-H09", "PROB-H15", "PROB-N-EXEM-14-LA-001", "PROB-N-EXEM-14-LA-002", "PYQ-M-2024-CG-006", "PYQ-M-2024-PROB-005",
  "PYQ-M-2024-QE-004b", "PYQ-M-2024-QE-005a", "PYQ-M-2024-QE-006a", "PYQ-M-2024-SAV-004a", "PYQ-M-2024-SAV-005", "PYQ-M-2024-SAV-006",
  "PYQ-M-2024-STAT-002", "PYQ-M-2024-STAT-003", "PYQ-M-2024-STAT-004", "PYQ-M-2024-STAT-005", "PYQ-M-2025-AP-002", "PYQ-M-2025-ARC-004",
  "PYQ-M-2025-PROB-007", "PYQ-M-2025-PROB-008", "PYQ-M-2025-QE-002", "PYQ-M-2025-SAV-004", "PYQ-M-2025-SAV-005", "PYQ-M-2025-SAV-006",
  "PYQ-M-2025-STAT-001", "PYQ-M-2025-STAT-002", "PYQ-M-2025-STAT-003", "PYQ-M-2025-STAT-004", "PYQ-M-2025-STAT-005", "PYQ-M-2025-STAT-006",
  "PYQ-M-2025-TRIG-005", "PYQ-M-2026-AP-001", "PYQ-M-2026-CG-002", "PYQ-M-2026-CIRC-006", "PYQ-M-2026-POLY-004", "PYQ-M-2026-POLY-005",
  "PYQ-M-2026-SAV-002", "PYQ-M-2026-SAV-003", "PYQ-M-AP-007", "PYQ-M-PROB-012", "PYQ-M-SAV-002", "PYQ-M-SAV-003",
  "PYQ-M-SAV-004", "PYQ-M-SAV-005", "PYQ-M-STAT-008", "PYQ-M-STAT-009", "PYQ-M-STAT-010", "PYQ-M-TRI-005",
  "PYQ-M-TRI-006", "PYQ-M-TRIG-008", "PYQ-M-TRIG-009", "PYQ-M-TRIG-010", "PYQ-S-ACID-013", "PYQ-S-CHEM-013",
  "PYQ-S-CHEM-014", "PYQ-S-CHEM-016", "PYQ-S-ELEC-003", "PYQ-S-ELEC-004", "PYQ-S-ELEC-005", "PYQ-S-ELEC-006",
  "PYQ-S-LIGHT-011", "PYQ-S-LIGHT-012", "PYQ-S-LIGHT-013", "SAV-H10", "SAV-N-EXMPLR-12-LA-004", "SAV-N-EXMPLR-12-LA-006",
  "SAV2-R13", "SAV2P1-R06", "SCQ-S-ACID-039", "SCQ-S-ACID-040", "SCQ-S-ACID-041", "SCQ-S-ACID-042",
  "SCQ-S-ACID-043", "SCQ-S-ACID-044", "SCQ-S-CARB-038", "SCQ-S-CARB-039", "SCQ-S-CARB-040", "SCQ-S-CARB-041",
  "SCQ-S-CARB-042", "SCQ-S-CARB-043", "SCQ-S-CHEM-035", "SCQ-S-CHEM-036", "SCQ-S-CHEM-037", "SCQ-S-CHEM-038",
  "SCQ-S-CHEM-039", "SCQ-S-CHEM-040", "SCQ-S-CTRL-039", "SCQ-S-CTRL-040", "SCQ-S-CTRL-041", "SCQ-S-CTRL-042",
  "SCQ-S-CTRL-043", "SCQ-S-ELEC-036", "SCQ-S-ELEC-037", "SCQ-S-ELEC-038", "SCQ-S-ELEC-039", "SCQ-S-ELEC-040",
  "SCQ-S-ELEC-041", "SCQ-S-ENV-039", "SCQ-S-EYE-033", "SCQ-S-EYE-034", "SCQ-S-EYE-035", "SCQ-S-EYE-036",
  "SCQ-S-EYE-037", "SCQ-S-EYE-038", "SCQ-S-HERED-039", "SCQ-S-HERED-040", "SCQ-S-HERED-041", "SCQ-S-HERED-042",
  "SCQ-S-HERED-043", "SCQ-S-LIFE-039", "SCQ-S-LIFE-040", "SCQ-S-LIFE-041", "SCQ-S-LIFE-042", "SCQ-S-LIFE-043",
  "SCQ-S-LIFE-044", "SCQ-S-LIGHT-039", "SCQ-S-LIGHT-040", "SCQ-S-LIGHT-041", "SCQ-S-LIGHT-042", "SCQ-S-LIGHT-043",
  "SCQ-S-LIGHT-044", "SCQ-S-MAG-039", "SCQ-S-MAG-040", "SCQ-S-MAG-041", "SCQ-S-MAG-042", "SCQ-S-MAG-043",
  "SCQ-S-MAG-044", "SCQ-S-METAL-039", "SCQ-S-METAL-040", "SCQ-S-METAL-041", "SCQ-S-METAL-042", "SCQ-S-METAL-043",
  "SCQ-S-METAL-044", "SCQ-S-REPR-039", "SCQ-S-REPR-040", "SCQ-S-REPR-041", "SCQ-S-REPR-042", "SCQ-S-REPR-043",
  "SCQ-S-REPR-044", "SP-M-2022-AP-E-001", "SP-M-2022-ARC-E-001", "SP-M-2022-TRIG-E-001", "SQP-S-2025-LGHT-038", "STAT-N-EXEM-13-LA-001",
  "STAT-N-EXEM-13-LA-002", "STAT-N-NCERT-13-LA-001", "STAT-N-NCERT-13-LA-002", "STAT2-R09", "TRIG-N-EXMPLR-8-LA-001", "TRIG-N-EXMPLR-8-LA-003",
  "TRIG-N-EXMPLR-9-LA-004", "Z3-AP-002", "Z3-AP-003", "Z3-AP-007", "Z3-AP-008", "Z3-AP-009",
  "Z3-ARC-002", "Z3-ARC-003", "Z3-QE-004", "Z3-QE-005", "Z3-QE-006", "Z3-SAV-004",
  "Z3-ST-003",
];
...
export const AI_GENERATED_SOLUTION_IDS: ReadonlySet<string> = new Set([
  ...
  // 223 genuine D/E rows whose solutionSteps were never broken out into the CBSE
  // per-step [N mark] scheme. Questions untouched; solutionSteps (+ absent/garbled
  // finalAnswer) AI-re-authored, PENDING OWNER VERIFICATION — hence rank-demoted here.
  ...CLASS_B_STEPPED_SOLUTION_IDS,
]);
