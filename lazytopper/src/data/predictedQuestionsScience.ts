...
export type QuestionKind = "MCQ" | "Short" | "Long" | "Assertion-Reasoning" | "Case-Based";
...
export const sciencePredictedQuestions: SciencePredictedQuestion[] = [
...

  {
    ...
    solutionSteps: [
      "Write formulas of reactants: BaCl₂ and Na₂SO₄.; Exchange ions to get BaSO₄ and NaCl. [½]",
      "Balance the equation: 1 Ba, 1 S, 2 Na, 2 Cl. [½]",
      "Recognise that ions are exchanged and an insoluble solid forms. [1]",
    ],
    strategyHint:
...

  {
    ...
    solutionSteps: [
      "Recall: oxidation = gain of oxygen, reduction = loss of oxygen.; Identify which substance combines with oxygen. [1]",
      "Copper combines with oxygen → oxidised. [1]",
      "Elemental oxygen is consumed → reduced. [1]",
    ],
    strategyHint:
...

  {
    ...
    solutionSteps: [
      "(i) The reactants are barium chloride (BaCl₂) and sodium sulphate (Na₂SO₄). The products are barium sulphate (BaSO₄) and sodium chloride (NaCl).; (i) The balanced chemical equation is: BaCl₂(aq) + Na₂SO₄(aq) → BaSO₄(s) + 2NaCl(aq). [1]",
      "(ii) The white precipitate formed is Barium sulphate (BaSO₄).; (iii) The law of chemical combination verified by this experiment is the Law of conservation of mass. [1]",
      "(iv) The mass remains unchanged because the reaction is carried out in a closed test tube, preventing any matter from entering or leaving the system. [1]",
      "(iv) According to the Law of conservation of mass, the total mass of reactants equals the total mass of products in a closed system, even if a new substance like a precipitate is formed. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "(a) The chemical name of baking soda is Sodium hydrogen carbonate.; (a) Its chemical formula is NaHCO₃. [½]",
      "(b) One use of baking soda is as a leavening agent in baking. [½]",
      "(b) When heated during baking, it decomposes to produce carbon dioxide gas, which makes cakes and bread fluffy. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Plaster of Paris is calcium sulphate hemihydrate.; Its chemical formula is CaSO₄·½H₂O. [1]",
      "It is obtained by heating gypsum (CaSO₄·2H₂O) at about 373 K (100°C).; CaSO₄·2H₂O(s) --(373 K)--> CaSO₄·½H₂O(s) + 1½H₂O(g) [1]",
      "It should be stored in a moisture-proof container because it readily absorbs moisture and sets into a hard mass of gypsum. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "A pH of 5.0 is less than 7, indicating the soil is acidic.; To adjust acidic soil, the farmer can add basic substances like quicklime (calcium oxide, CaO) or slaked lime (calcium hydroxide, Ca(OH)₂). [1]",
      "Very low pH (acidic soil) damages the roots of crops, hindering their growth and development.; It also reduces the availability and uptake of essential nutrients by plants, leading to nutrient deficiencies. [1]",
      "Such pH-related questions are important in agriculture because proper soil pH is crucial for optimum nutrient absorption by plants. [1]",
      "Maintaining the correct pH ensures healthy plant growth, better crop yield, and efficient use of fertilizers. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Corrosion is the gradual deterioration of metals.; It occurs due to reaction with air, moisture, or chemicals. [½]",
      "Corrosion of iron is called rusting. [½]",
      "It can be prevented by galvanisation (coating with zinc). [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Sodium and potassium are highly reactive metals.; They react vigorously with oxygen and moisture in the air. [1]",
      "Therefore, they are stored under kerosene to prevent this reaction.; Aluminium forms a thin, protective layer of aluminium oxide (Al2O3) on its surface when exposed to air. [1]",
      "This oxide layer is stable and prevents further corrosion of the underlying metal. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "For metal X (middle of reactivity series) as oxide, reduction using a suitable reducing agent like carbon (smelting) is used.; Calcination is heating the ore in the absence or limited supply of air to remove volatile impurities. [1]",
      "Highly reactive metals form very stable compounds with oxygen and other elements. [1]",
      "Only strong reducing conditions, such as electrolytic reduction, can break these stable bonds to obtain the pure metal. [1]",
      "An example of a highly reactive metal obtained by electrolysis is sodium (Na) or potassium (K) or aluminium (Al). [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "(a) A homologous series is a group of organic compounds having the same functional group and general formula.; Successive members of the series differ by a -CH₂- group. [½]",
      "(b) Characteristic 1: Members of a homologous series show similar chemical properties due to the same functional group. [½]",
      "(b) Characteristic 2: There is a gradation in physical properties (e.g., melting point, boiling point) as molecular mass increases, and successive members differ by a constant mass of 14 u. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Drinking alcohol affects the central nervous system, slowing reflexes and impairing judgment and coordination.; Long-term consumption can lead to severe liver damage, including conditions like cirrhosis. [1]",
      "Alcohol can cause addiction, leading to physical and psychological dependence. [1]",
      "It contributes to various social problems such as accidents, violence, and financial difficulties. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Soap molecules have a hydrophobic (oil-attracting) tail and a hydrophilic (water-attracting) head.; The hydrophobic tails attach to the oil/grease, while the hydrophilic heads face the water, forming an emulsion that can be rinsed away. [1]",
      "A micelle is a spherical aggregate of soap molecules in water, with hydrophobic tails oriented inwards and hydrophilic heads outwards. [1]",
      "Soaps form scum in hard water because they react with calcium and magnesium ions to form insoluble precipitates. [1]",
      "Synthetic detergents do not form scum with hard water, making them effective for washing in both soft and hard water. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "(i) Bile emulsifies large fat globules into smaller ones, increasing the surface area for enzyme action.; Bile also provides an alkaline medium in the duodenum, essential for the optimal activity of pancreatic enzymes. [½]",
      "(ii) Pancreatic juice contains digestive enzymes such as trypsin, amylase, and lipase. [½]",
      "These enzymes digest proteins, starch, and fats, respectively, into simpler forms. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Draw a clear and proportionate diagram of the human heart.; Label the four chambers: right atrium, left atrium, right ventricle, and left ventricle. [1]",
      "Label the major blood vessels connected to the heart: superior/inferior vena cava, pulmonary artery, pulmonary veins, and aorta.; Use arrows to clearly indicate the direction of blood flow through all chambers and vessels, showing double circulation. [1]",
      "Ensure all labels are accurate, legible, and correctly placed. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Excretion is the biological process of removal of harmful metabolic waste products from the body.; The basic filtration unit of the kidney is the nephron. [1]",
      "A diagram of the nephron should be drawn. [1]",
      "The diagram must clearly show Bowman’s capsule, glomerulus, renal tubule, and collecting duct. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "(i) The life process directly affected is Nutrition.; (ii) Improper nutrition leads to insufficient supply of glucose and other essential nutrients. [1]",
      "(ii) This impairs efficient cellular respiration, which is the process of releasing energy from food.; (ii) Consequently, the body produces less energy, causing weakness and tiredness. [1]",
      "(iii) The pigment that transports oxygen in blood is Haemoglobin. [1]",
      "(iv) Dietary changes should include iron-rich foods like green leafy vegetables, jaggery, and pulses. Also ensure adequate intake of carbohydrates and proteins. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Double circulation means that blood passes through the human heart twice during one complete cycle of circulation.; It involves two distinct pathways: the pulmonary circulation and the systemic circulation. [1]",
      "Deoxygenated blood from the body enters the right atrium, then moves to the right ventricle.; From the right ventricle, it is pumped to the lungs for oxygenation (pulmonary circulation). [1]",
      "Oxygenated blood from the lungs returns to the left atrium, then moves to the left ventricle.; The left ventricle pumps this oxygenated blood to various parts of the body (systemic circulation). [1]",
      "Deoxygenated blood from the body then returns to the right atrium, completing the cycle. [1]",
      "A simple flow diagram should be drawn illustrating this complete path from the right atrium back to the right atrium. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "A reflex action is defined as a rapid, involuntary, and automatic response to a stimulus.; It occurs without conscious thought or control from the brain, involving a reflex arc. [½]",
      "Reflex actions are crucial for survival as they provide immediate protection against harmful stimuli. [½]",
      "For example, quickly withdrawing a hand from a hot object prevents severe burns and injury. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Two plant hormones are: Auxin and Gibberellin.; Function of Auxin: Promotes cell elongation, especially in stems and shoots, and regulates growth. [1]",
      "Function of Gibberellin: Promotes stem elongation, seed germination, and flowering.; Plants bend towards light due to a phenomenon called phototropism, mediated by the hormone auxin. [1]",
      "When light falls on a plant from one direction, auxin migrates to the shaded side, causing cells on the shaded side to elongate more rapidly than those on the illuminated side, thus bending the plant towards the light source. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "The symptoms of stunted growth and poor development of secondary sexual characters indicate an imbalance in body regulation.; This type of regulation is primarily controlled by chemical messengers, pointing to the endocrine (hormonal) system. [1]",
      "Growth hormone is the specific hormone responsible for promoting overall body growth.; The pituitary gland is known as the master gland and secretes growth hormone. [1]",
      "Hormonal coordination involves hormones traveling through the bloodstream to reach target organs, which is a relatively slow process. [1]",
      "Nervous coordination involves rapid electrical impulses transmitted along nerve fibers, leading to much quicker responses. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Binary fission is a type of asexual reproduction where the parent cell divides into two approximately equal daughter cells.; An example of an organism that reproduces by binary fission is Amoeba. [½]",
      "Multiple fission is an asexual reproduction method where the parent cell divides into many daughter cells simultaneously. [½]",
      "An example of an organism that reproduces by multiple fission is Plasmodium. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Testes: Produce male gametes (sperms).; Testes: Produce male sex hormone (testosterone). [1]",
      "Ovaries: Produce female gametes (ova).; Ovaries: Produce female sex hormones (oestrogen and progesterone). [1]",
      "Uterus: Site of implantation of the fertilised egg and development of the embryo/foetus. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Pollen grains land on the stigma and germinate, forming a pollen tube.; The pollen tube grows through the style and enters the ovule, carrying two male gametes. [1]",
      "One male gamete fuses with the egg cell (syngamy) to form the zygote.; The other male gamete fuses with the polar nuclei to form the endosperm. [1]",
      "This process involving two fusions is known as double fertilisation. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Mendel crossed pure tall (TT) pea plants with pure dwarf (tt) pea plants (P generation).; All offspring in the F₁ generation were tall (Tt), demonstrating the dominance of the tall trait. [1]",
      "He then self-pollinated the F₁ generation plants (Tt x Tt).; In the F₂ generation, he observed both tall and dwarf plants. [1]",
      "The phenotypic ratio in the F₂ generation was 3 tall : 1 dwarf. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "State the mirror formula: 1/f = 1/v + 1/u.; Define terms: f is focal length, v is image distance, u is object distance. All are measured from the pole. [½]",
      ...
      "Distances in the opposite direction are negative. Heights above the principal axis are positive, below are negative. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Given: Object distance u = -20 cm (as per sign convention), Focal length f = +10 cm (for converging lens).; Apply the lens formula: 1/f = 1/v - 1/u. [1]",
      "Substitute the values: 1/10 = 1/v - 1/(-20).; Solve for v: 1/v = 1/10 - 1/20 = 2/20 - 1/20 = 1/20. So, v = +20 cm. [1]",
      "The image is formed at 20 cm on the other side of the lens. It is real, inverted, and same size. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Draw three neat ray diagrams for a concave mirror, clearly marking the pole (P), principal focus (F), and centre of curvature (C).; (i) Object beyond C: Image forms between F and C. It is real, inverted, and diminished. [1]",
      "(ii) Object at C: Image forms at C. It is real, inverted, and same size as the object.; (iii) Object between F and C: Image forms beyond C. It is real, inverted, and enlarged. [1]",
      "Each diagram must use at least two correct incident and reflected rays to locate the image. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "The phenomenon responsible is refraction of light.; Lateral displacement occurs due to successive refractions at the two parallel interfaces (air-glass and glass-air). [1]",
      "The light ray bends twice, once towards the normal and once away from it, resulting in a shift.; Greater thickness of the glass slab leads to a larger lateral displacement of the emergent ray. [1]",
      "In a glass slab, the emergent ray is parallel to the incident ray. [1]",
      "In a prism, the emergent ray is deviated from the incident ray and is not parallel to it. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Magnification (m) is defined as the ratio of the height of the image (h') to the height of the object (h).; Consider an object placed in front of a spherical mirror, forming an image. Draw a ray diagram. [1]",
      "By using similar triangles formed by the object, image, and the principal axis (e.g., triangle ABP and A'B'P).; The ratio of image height to object height (h'/h) is equal to the ratio of image distance to object distance (v/u). [1]",
      "Applying the sign conventions (heights above axis positive, below negative; distances measured from pole), we get m = h'/h = -v/u. [1]",
      "For real images, the image is inverted, so h' is negative, making the magnification (m) negative. [1]",
      "For virtual images, the image is erect, so h' is positive, making the magnification (m) positive. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      ...
      "Therefore, the image distance v = -30 cm. Since v is negative, the image is real and formed 30 cm in front of the mirror. The image is inverted and enlarged. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      ...
      "This relationship is given by the formula: n = c / v. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      ...
      "Substitute the given values: 1/15 = 1/30 - 1/u. Rearrange to find 1/u: 1/u = 1/30 - 1/15.; Calculate 1/u: 1/u = (1 - 2)/30 = -1/30. Therefore, the object position u = -30 cm. [1]",
      "Calculate magnification: m = v/u = 30/(-30) = -1. The image is real, inverted, and of the same size as the object. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      ...
      "Rule 3: A ray of light passing through the first principal focus (F₁) emerges parallel to the principal axis after refraction.; When an object is placed at the focus F₁ of a convex lens, the rays of light from the object, after refraction, become parallel to each other. [1]",
      "Therefore, the image is formed at infinity, and its nature is real, inverted, and highly enlarged. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Myopia, also known as short-sightedness, is a common defect of vision.; A person suffering from myopia can see nearby objects clearly, but distant objects appear blurred. [½]",
      "This defect occurs because the eye lens focuses light from distant objects in front of the retina. [½]",
      "Myopia can be corrected by using spectacles fitted with a concave (diverging) lens of appropriate power. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "The Earth's atmosphere consists of layers of air with varying optical densities, denser near the surface.; When the Sun is below the horizon, light from it travels from a rarer medium (space) to a denser medium (atmosphere). [1]",
      "This light undergoes continuous refraction, bending towards the normal as it passes through increasingly denser air layers.; Due to this atmospheric refraction, the light rays appear to come from a higher position. [1]",
      "Therefore, the Sun appears slightly above the horizon even when it is actually below it at sunrise and sunset. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Identify the given values: Potential difference (V) = 10 V, Current (I) = 0.5 A.; State Ohm's law: V = IR, which can be rearranged to R = V/I. [½]",
      "Substitute the values into the formula: R = 10 V / 0.5 A. [½]",
      "Calculate the resistance: R = 20 Ω. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Identify the given ratings: Voltage (V) = 220 V, Power (P) = 100 W.; For (i) Current drawn: Use the formula P = VI. Rearrange to I = P/V. [1]",
      "Substitute values: I = 100 W / 220 V = 0.4545 A (approx 0.455 A).; For (ii) Resistance of the bulb: Use the formula P = V²/R. Rearrange to R = V²/P. [1]",
      "Substitute values: R = (220 V)² / 100 W = 48400 / 100 = 484 Ω. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Fuse wire is connected in series with the live wire to ensure all circuit current passes through it.; When current exceeds a safe limit, the fuse wire, having a low melting point, heats up and melts. [1]",
      "This breaks the circuit, preventing damage to appliances and potential fire hazards. [1]",
      "It works on the principle of the heating effect of electric current (Joule's heating). [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Given resistors: R1=2Ω, R2=4Ω, R3=6Ω. Voltage V=12V. Time t=2 minutes = 120 seconds.; (i) For series connection: Total resistance Rs = R1 + R2 + R3 = 2 + 4 + 6 = 12 Ω. [1]",
      "Total current Is = V / Rs = 12 V / 12 Ω = 1 A.; Heat produced Hs = Is² * Rs * t = (1 A)² * 12 Ω * 120 s = 1440 J. [1]",
      "(ii) For parallel connection: 1/Rp = 1/R1 + 1/R2 + 1/R3 = 1/2 + 1/4 + 1/6.; 1/Rp = (6 + 3 + 2) / 12 = 11/12. So, Rp = 12/11 Ω (approx 1.09 Ω). [1]",
      "Total current Ip = V / Rp = 12 V / (12/11 Ω) = 11 A. [1]",
      "Heat produced Hp = Ip² * Rp * t = (11 A)² * (12/11 Ω) * 120 s = 11 * 12 * 120 = 15840 J. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Draw a bar magnet. Show magnetic field lines emerging from the North pole and entering the South pole.; Ensure the lines form continuous closed loops and are denser near the poles, indicating a stronger field. [½]",
      "Property 1: Magnetic field lines emerge from the North pole and enter the South pole outside the magnet. [½]",
      "Property 2: Magnetic field lines never intersect each other. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "In a series combination, total resistance R_total = R1 + R2.; Substitute R1 = 3 Ω and R2 = 6 Ω: R_total = 3 + 6 = 9 Ω. [½]",
      "Apply Ohm's law: I = V / R_total = 9 V / 9 Ω. [½]",
      "Therefore, total current I = 1 A. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Given: Power (P) = 60 W, Voltage (V) = 220 V.; (a) Use the formula P = VI. Rearrange to find current: I = P / V. [1]",
...
A proper fuse rating slightly above 3.9 A is used so it melts if current exceeds safe limit, protecting appliances and preventing fire.`,
    ...
    solutionSteps: [
      "(a) Calculate total power: P_iron = 750 W, P_fan = 75 W, P_bulbs = 2 * 15 W = 30 W.; Total power (P_total) = 750 W + 75 W + 30 W = 855 W. [1]",
      "Total current (I_total) = P_total / V = 855 W / 220 V ≈ 3.886 A (approx 3.9 A).; (b) A fuse is a safety device designed to protect electrical circuits and appliances from excessive current. [1]",
      "Using a proper rating of fuse ensures that it melts and breaks the circuit if the current exceeds a safe limit. [1]",
      "This prevents damage to appliances, short circuits, and potential fire hazards caused by overheating. [1]",
    ],
...
Use: electric bell, crane to lift scrap iron, etc.`,
    ...
    solutionSteps: [
      "An electromagnet is a temporary magnet produced when electric current flows through a coil of wire wound around a soft iron core.; The strength of an electromagnet depends on the number of turns in the coil; more turns lead to a stronger electromagnet. [1]",
      "It also depends on the magnitude of current flowing through the coil; a higher current results in a stronger electromagnet.; Another factor is the nature of the core material; using a soft iron core significantly increases strength. [1]",
      "One common use of electromagnets in daily life is in electric bells. [1]",
    ],
...
(b) Workers should avoid standing under suspended loads, ensure power is switched off before maintenance, and keep electronic devices away from strong magnetic fields (any two).`,
  ...
  (b) The ciliary muscles change the curvature of the eye lens to adjust its focal length (power of accommodation).`,
      ...
      solutionSteps: [
        "(a) Persistence of vision: the image formed on the retina persists for about 1/16 s after the object is removed.; This property is used in cinema — rapid display of frames creates the illusion of continuous motion. [½]",
        "(b) Power of accommodation: the ability of the eye lens to adjust its focal length to see objects at different distances. [½]",
        "The ciliary muscles contract (near objects) or relax (far objects), changing the curvature and hence focal length of the eye lens. [1]",
      ],
...
The phenomenon responsible is atmospheric refraction.`,
    ...
    solutionSteps: [
      "Stars appear as point sources of light. Their light passes through many atmospheric layers with varying refractive indices.; As these layers shift due to air currents, the apparent position and brightness of the star changes continuously — this is twinkling. [1]",
      "Planets have a much larger apparent disc size. The atmospheric variations average out across the disc, so their brightness remains steady — planets do not twinkle. [1]",
      "The phenomenon responsible for the apparent twinkling of stars is atmospheric refraction. [1]",
    ],
...
(c) Example: bluish colour of smoke, danger signals painted red (any one linked with scattering).`,
...

  {
    ...
    solutionSteps: [
      "Double circulation means blood passes through the heart twice in one complete circuit — once via the pulmonary circuit and once via the systemic circuit.; The pulmonary circuit carries deoxygenated blood from the heart to the lungs for oxygenation, and returns oxygenated blood to the heart. [½]",
      "The systemic circuit then pumps this oxygenated blood from the heart to all body tissues.; This separation ensures oxygenated and deoxygenated blood never mix, maintaining a consistently high oxygen supply to tissues. [½]",
      "High oxygen supply is essential for efficient aerobic respiration and energy release, which warm-blooded animals like humans require to maintain body temperature. [1]",
    ],
...
Function of kidneys: filtration of blood to remove nitrogenous wastes like urea and regulation of water and salt balance (any relevant function).`,
    ...
    solutionSteps: [
      "Draw a neat, well-proportioned outline diagram of the human excretory system.; Label the two kidneys (bean-shaped organs located on either side of the vertebral column). [1]",
      "Label the two ureters, which carry urine from the kidneys to the urinary bladder.; Label the urinary bladder, which temporarily stores urine. [1]",
      "Label the urethra, through which urine is expelled from the body.; Function of kidneys: The kidneys filter blood to remove nitrogenous waste products like urea, and also regulate water and mineral salt balance in the body. [1]",
    ],
...
(b) Dietary changes: include more fruits, vegetables and whole grains; reduce fried and sugary foods. Lifestyle change: regular physical exercise / sports / walking, etc.`,
    ...
    solutionSteps: [
      "(a) Rita is likely to suffer from obesity with micronutrient deficiency.; Fast foods are high in fats, sugars, and calories but low in essential vitamins and minerals. [1]",
      "Excess caloric intake leads to fat accumulation (obesity), while deficiency of micronutrients causes fatigue and poor health.; (b) Dietary change 1: Include more fruits, vegetables, whole grains, and legumes in daily meals. [1]",
      "Dietary change 2: Reduce or avoid fried foods, aerated drinks, and processed/junk food. [1]",
      "Lifestyle change: Engage in regular physical exercise such as walking, jogging, or sports for at least 30 minutes a day. [1]",
    ],
...
Fe + CuSO₄ → FeSO₄ + Cu`,
    ...
    solutionSteps: [
      "Iron is more reactive than copper, as per the reactivity series.; When iron nail is dipped in copper sulphate solution, iron displaces copper from the solution. [½]",
      "The displaced copper metal gets deposited on the iron nail, forming a reddish-brown layer. [½]",
      "The balanced chemical equation is: Fe(s) + CuSO4(aq) -> FeSO4(aq) + Cu(s). [1]",
    ],
...
Series is of alcohols: CH₃–OH, C₂H₅–OH, C₃H₇–OH, C₄H₉–OH. So 3rd and 4th members: C₃H₇–OH and C₄H₉–OH.`,
    ...
    solutionSteps: [
      "A homologous series is a series of organic compounds with the same functional group and similar chemical properties.; Characteristic 1: All members of a homologous series share the same general formula. [1]",
      "Characteristic 2: Successive members differ by a -CH2- group and 14 amu in molecular mass.; The first member CH₃–OH is methanol, belonging to the alcohol homologous series (general formula CnH2n+1OH). [1]",
      "The third member is propanol (C₃H₇OH) and the fourth member is butanol (C₄H₉OH). [1]",
    ],
...
(c) Detergents are non-biodegradable and cause water pollution / foam in rivers, etc.`,
    ...
    solutionSteps: [
      "Soap molecule has a hydrophilic head and a hydrophobic tail. [1]",
      "Hydrophobic tails attach to oil/grease, while hydrophilic heads face water. [1]",
      "This forms a spherical structure called a micelle, trapping the dirt. [1]",
      "Micelles repel each other and remain suspended in water, washing away dirt. [1]",
    ],
...
They protect the body from injury and enable quick responses without involving the thinking brain.`,
    ...
    solutionSteps: [
      "A reflex action is a sudden, involuntary, and automatic response of the body to a stimulus.; Example: Immediate withdrawal of hand upon touching a hot object. [½]",
      "Reflex actions are important as they provide quick responses to dangerous stimuli, protecting the body from harm. [½]",
      "They allow for rapid survival responses without conscious thought, saving time in critical situations. [1]",
    ],
...
Sexual reproduction involves two parents and fusion of gametes leading to variation, e.g. reproduction in humans / flowering plants.`,
    ...
    solutionSteps: [
      "State that asexual reproduction involves one parent, while sexual reproduction involves two parents.; Mention that asexual reproduction does not involve gametes, but sexual reproduction involves gamete formation and fusion. [½]",
      "Give budding in Hydra as an example of asexual reproduction. [½]",
      "Give humans as an example of sexual reproduction. [1]",
    ],
...
Phenotypes: 3 tall : 1 dwarf.`,
    ...
    solutionSteps: [
      "Show the P generation cross (TT x tt) and the resulting F1 generation (all Tt, Tall).; Indicate the F1 self-cross (Tt x Tt) and the gametes (T, t from each parent). [1]",
      "Draw the Punnett square for the F2 generation, showing TT, Tt, Tt, tt genotypes.; State the F2 genotypic ratio as 1 TT : 2 Tt : 1 tt. [1]",
      "State the F2 phenotypic ratio as 3 Tall : 1 Dwarf. [1]",
    ],
...

  {
    ...
    solutionSteps: [
      "Draw the circuit: R1 in series with a branch containing R2 and R3 in parallel.; Calculate equivalent of parallel branch using reciprocal formula. [1]",
      "Add R1 to get total equivalent resistance. [1]",
      "Use Ohm's law to get total current from source. [1]",
      "Find branch voltage and then branch currents using I = V/R. [1]",
      "State final values with correct SI units. [1]",
    ],
    strategyHint:
...

  {
    ...
    solutionSteps: [
      "Draw a neat, labelled diagram of the human digestive system. [1]",
      "Explain role of HCl in the stomach. [1]",
      "Explain role of bile juice in fat emulsification. [1]",
      "Explain how villi aid absorption. [1]",
...

  {
    ...
    solutionSteps: [
      "Draw and label the heart diagram. [1]",
      "Define double circulation with both circuits. [1]",
      "Explain pulmonary circulation path. [1]",
      "Explain systemic circulation path. [1]",
...

  {
    ...
    solutionSteps: [
      "Draw and label the reflex arc components. [1]",
      "Describe the stimulus detection. [1]",
      "Trace the nerve impulse pathway. [1]",
      "Explain the response mechanism. [1]",
...

  {
    ...
    solutionSteps: [
      "Draw a neat, labelled diagram of the female reproductive system. [2]",
      "Ovary produces eggs (ova) and female hormones (oestrogen, progesterone). [1]",
      "Fallopian tube is the site of fertilisation and carries the egg to the uterus. [1]",
...

  {
    ...
    solutionSteps: [
      "Write lens formula: 1/v − 1/u = 1/f.; Substitute u = −30 cm, f = 15 cm. [1]",
      "Solve for v. [1]",
      "Calculate magnification m = v/u. [1]",
      "Determine image size and nature. [1]",
...

  {
    ...
    solutionSteps: [
      "State the ore and metal. [1]",
      "Describe concentration method. [1]",
      "Write the roasting equation. [1]",
      "Write the reduction equation. [1]",
...

  {
    ...
    solutionSteps: [
      "State the P generation cross. [1]",
      "Show F₁ generation — all heterozygous tall. [1]",
      "Set up Punnett square for F₁ × F₁. [1]",
      "List all genotypes in F₂. [1]",
...

  {
    ...
    solutionSteps: [
      "Write equation for thermal decomposition of NaHCO₃. [1]",
      "Write equation for hydration of Na₂CO₃. [1]",
      "List uses of washing soda. [1]",
      "List uses of baking soda. [1]",
