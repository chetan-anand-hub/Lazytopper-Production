...
const predictedQuestionsAdditions: PredictedQuestion[] = [
...

  {
    ...
    solutionSteps: [
      "Find prime factorisations: 4=2², 7=7, 14=2×7.; LCM = 2²×7 = 28 minutes. [1]",
      "Add 28 minutes to 6:00 AM. [1]",
      "For irrationality: assume √5 = p/q in lowest terms. [1]",
      "Square both sides and derive contradiction. [1]",
      "Conclude √5 is irrational. [1]",
    ],
