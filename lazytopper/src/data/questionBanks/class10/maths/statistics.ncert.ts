...
export const STAT_NCERT: CanonicalQuestion[] = [
  ...
  { id: "STAT-N-NCERT-13-LA-001", subject: "Maths", topicKey: "statistics", subtopic: "Mean Mode Median Comparison", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Evaluating",
    ...
    solutionSteps: ["[1 mark] Setup: n = 68, n/2 = 34. Cumulative frequencies: 4, 9, 22, 42, 56, 64, 68, so the median class is 125-145 (first cf ≥ 34); l = 125, cf = 22, f = 20, h = 20.", "[1 mark] Median = l + ((n/2 − cf)/f) × h = 125 + ((34 − 22)/20) × 20 = 125 + 12 = 137 units.", "[1 mark] Mean by direct method: class marks 75, 95, 115, 135, 155, 175, 195; Σfx = 300 + 475 + 1495 + 2700 + 2170 + 1400 + 780 = 9320.", "[1 mark] Mean = Σfx/Σf = 9320/68 ≈ 137.06 units.", "[1 mark] Mode: modal class 125-145 (f₁ = 20, f₀ = 13, f₂ = 14, h = 20); Mode = 125 + ((20 − 13)/(40 − 13 − 14)) × 20 = 125 + (7/13) × 20 ≈ 135.77 units. Comparing: Mean (137.06) ≈ Median (137) > Mode (135.77), so the distribution is nearly symmetric."],
  ...
  { id: "STAT-N-NCERT-13-LA-002", subject: "Maths", topicKey: "statistics", subtopic: "Median of Grouped Data", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Analysing",
    ...
    solutionSteps: ["[1 mark] The total frequency is 100 and the known frequencies sum to 76, so 76 + x + y = 100 ⇒ x + y = 24 …(i).", "[1 mark] Median = 525 lies in the class 500-600, so l = 500, f = 20, h = 100 and n/2 = 50.", "[1 mark] Cumulative frequency preceding the median class: cf = 2 + 5 + x + 12 + 17 = 36 + x.", "[1 mark] Apply the median formula: 525 = 500 + [(50 − (36 + x))/20] × 100 ⇒ 25 = (14 − x) × 5 ⇒ 14 − x = 5 ⇒ x = 9.", "[1 mark] From (i): y = 24 − 9 = 15. Hence x = 9 and y = 15."],
