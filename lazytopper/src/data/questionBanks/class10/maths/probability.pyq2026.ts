...
export const PROBABILITY_PYQ_2026: CanonicalQuestion[] = [
  { id: "PYQ-M-2026-PROB-001", subject: "Maths", topicKey: "probability", subtopic: "Ball Probability", section: "B", marks: 2, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    answer: "Number of yellow balls 25 = 1 −3 5 = 2 5 ⟹Number of yellow balls = 25 × 2 5 =",
    solutionSteps: ["P(getting a yellow ball) = 1 −P(getting a green ball)", "Number of yellow balls 25 = 1 −3 5 = 2 5 ⟹Number of yellow balls = 25 × 2 5 ="],
    finalAnswer: "Number of yellow balls 25 = 1 −3 5 = 2 5 ⟹Number of yellow balls = 25 × 2 5 =",
  ...
  { id: "PYQ-M-2026-PROB-002", subject: "Maths", topicKey: "probability", subtopic: "Ball Probability", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Evaluating",
    questionText: "A bag contains 30 balls out of which 'm' number of balls are blue in colour. (i) Find the probability that a ball drawn at random from the bag is not blue. (ii) If 6 more blue balls are added in the bag, then the probability of drawing a blue ball will be 4 5 times the probability of drawing a blue ball in the first case. Find the value of m.",
    answer: "m =",
    solutionSteps: ["(i) P(ball drawn is not blue) = 30 − 𝑚 30 or 1 − 𝑚 30 (ii) Total number of balls now = 36 Number of blue balls now = m + 6 P(ball drawn is blue) = 𝑚+6 36 According to question, 𝑚+6 36 = 5 4 × 𝑚 30", "m ="],
    finalAnswer: "m =",
