...
export const SURFACE_AREAS_AND_VOLUMES_APQ: CanonicalQuestion[] = [
  ...
  { id: "APQ-M-SAV-006", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Cylinders from Folded Sheets", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Analysing",
    ...
    solutionSteps: ["[Variant 1] Sheet 1 height = 155 cm, overlap area wasted = 155 × 1 = 155 cm^2. Sheet 2 height = 45 cm, overlap area = 45 × 1 = 45 cm^2. Difference in CSA = 155 − 45 = 110 cm^2.", "(ii) Sheet 1 circumference = 45 − 1 = 44 ⟹ r1 = 7 cm. Sheet 2 circumference = 155 − 1 = 154 ⟹ r2 = 49/2 cm. V1/V2 = (r1^2 · h1)/(r2^2 · h2).", "[OR] (i) From figure: container side = 2p; cans per direction = 4; total = 4 × 4 × 2 = 32 cans.", "(ii) Volume of can = πr^2·height with r = p/2. Solve 539 = πr^2·h to get p = 14 cm. Cube side = 28 cm. Internal volume = 28^3 = 21952 cm^3."],
  ...
  { id: "APQ-M-SAV-009", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Volume — Tanker, Cuboidal Tank, Spherical Matka", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    ...
    solutionSteps: ["Tanker volume = π·r^2·h = (22/7)·1·70 = 220 m^3. Cuboidal tank = 7·2·3 = 42 m^3.", "(i) 220/42 = 5.23, so 5 colonies can be supplied completely.", "Matka volume = (4/3)·π·r^3 = (4/3)·(22/7)·(21)^3 = 38,808 cm^3 ≈ 0.039 m^3.", "(ii) 3 colonies × 42 = 126 m^3. 400 matkas × 0.039 ≈ 16 m^3. Total ≈ 126 + 16 = 142 m^3."],
