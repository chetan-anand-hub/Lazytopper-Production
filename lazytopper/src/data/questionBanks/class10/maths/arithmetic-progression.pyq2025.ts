...
export const ARITHMETIC_PROGRESSION_PYQ_2025: CanonicalQuestion[] = [
  ...
  { id: "PYQ-M-2025-AP-002", subject: "Maths", topicKey: "arithmetic-progression", subtopic: "General", section: "E", marks: 4, format: "Case-Based", difficulty: "Hard", bloomSkill: "Applying",
    ...
    answer: "A.P formed is 300, 350, 400…… (i) a4 = 450 a5 = 500 a6 = 550 (ii) a8 = 300 +7 × 50 = 650 m (iii) (a) S10 = 10 2 × (2 × 300 + 9 × 50) = 5250 m OR (iii) (b) S6 = 6 2 × (2 × 300 + 5 × 50) = 2250 m 1",
    solutionSteps: ["A.P formed is 300, 350, 400…… (i) a4 = 450 a5 = 500 a6 = 550 (ii) a8 = 300 +7 × 50 = 650 m (iii) (a) S10 = 10 2 × (2 × 300 + 9 × 50) = 5250 m OR (iii) (b) S6 = 6 2 × (2 × 300 + 5 × 50) = 2250 m 1"],
    finalAnswer: "A.P formed is 300, 350, 400…… (i) a4 = 450 a5 = 500 a6 = 550 (ii) a8 = 300 +7 × 50 = 650 m (iii) (a) S10 = 10 2 × (2 × 300 + 9 × 50) = 5250 m OR (iii) (b) S6 = 6 2 × (2 × 300 + 5 × 50) = 2250 m 1",
