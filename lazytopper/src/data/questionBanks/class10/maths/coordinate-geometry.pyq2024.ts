...
export const COORDINATE_GEOMETRY_PYQ_2024: CanonicalQuestion[] = [
  { id: "PYQ-M-2024-CG-001", subject: "Maths", topicKey: "coordinate-geometry", subtopic: "General", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Applying",
    questionText: "The perpendicular bisector of the line segment joining the points A(– 1, 3) and B(2, 4) cuts the yaxis at :",
    options: ["(0, 5)", "(0, – 5)", "(0, 4)", "(0, – 4)"],
    answer: "(0, 5)",
    solutionSteps: ["Correct option: (a) (0, 5)."],
    finalAnswer: "(a) (0, 5)",
  ...
  { id: "PYQ-M-2024-CG-003", subject: "Maths", topicKey: "coordinate-geometry", subtopic: "Section Formula", section: "A", marks: 1, format: "Assertion-Reasoning", difficulty: "Medium", bloomSkill: "Applying",
    ...
    answer: "Assertion (A) is true but Reason (R) is false 1",
  ...
  { id: "PYQ-M-2024-CG-004a", subject: "Maths", topicKey: "coordinate-geometry", subtopic: "General", section: "B", marks: 2, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    answer: "k = 2 7 ∴ required ratio is 2 : 7 1 ½ ½",
    solutionSteps: ["Let the ratio be k:1 – 4 = 3k−6 k+1", "k = 2 7 ∴ required ratio is 2 : 7 1 ½ ½"],
    finalAnswer: "k = 2 7 ∴ required ratio is 2 : 7 1 ½ ½",
  ...
  { id: "PYQ-M-2024-CG-005a", subject: "Maths", topicKey: "coordinate-geometry", subtopic: "General", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    questionText: "In what ratio does the Xaxis divides theline segment joining the points(2,–3) and (5, 6) ? Also, find the coordinates of the point of intersection.",
    answer: "k = 1 2 ∴required ratio is 1: 2 ∴ x = 5×1+2×2 1+2 = 9 3 =3 ∴the co ordinate of the point of intersection is (3,0)",
    solutionSteps: ["Let the co ordinate of the point of intersection be (x, 0).", "Let ratio be k:1 ∴6k −3 k + 1 = 0", "k = 1 2 ∴required ratio is 1: 2 ∴ x = 5×1+2×2 1+2 = 9 3 =3 ∴the co ordinate of the point of intersection is (3,0)"],
    finalAnswer: "k = 1 2 ∴required ratio is 1: 2 ∴ x = 5×1+2×2 1+2 = 9 3 =3 ∴the co ordinate of the point of intersection is (3,0)",
  ...
  { id: "PYQ-M-2024-CG-007", subject: "Maths", topicKey: "coordinate-geometry", subtopic: "Section Formula", section: "E", marks: 4, format: "Case-Based", difficulty: "Hard", bloomSkill: "Applying",
    questionText: "A garden is in the shape of a square. The gardener grew saplings of Ashoka tree on the boundary of the garden at the distance of 1 m from each other. He wants to decorate the garden with rose plants. He chose a triangular region inside the garden to grow rose plants. In the above situation, the gardener took help from the students of class 10. They made a chart for it which looks like the given figure. Based on the above, answer the following questions : (i) If A is taken as origin, what are the coordinates of the vertices of D PQR ? 1 (ii) (a) Find distances PQ and QR. 2 OR (b) Find the coordinates of the point which divides the line segment joining points P and R in the ratio 2 : 1 internally. 2 (iii) Find out if D PQR is an isosceles triangle. 1 1530/5/1 àH$aU AÜ``Z –",
    answer: "( 16 3 , 16 3 ) (iii) PQ = √(4 −3)2 + (6 −2)2 = √17 QR = √(3 −6)2 + (2 −5)2 = √18 PR = √(4 −6)2 + (6 −5)2 = √5 PQ QR PR PQR is not isosceles",
    solutionSteps: ["(i) P (4, 6)", "Q (3, 2)", "R (6, 5) 1  17 (ii) (a) PQ = √(4 −3)2 + (6 −2)2 = √17 QR = √(3 −6)2 + (2 −5)2 = √18 OR (b) The coordinate of required point are (6 ×2+1×4 3 , 5 ×2+1×6 3 ) i.e.", "( 16 3 , 16 3 ) (iii) PQ = √(4 −3)2 + (6 −2)2 = √17 QR = √(3 −6)2 + (2 −5)2 = √18 PR = √(4 −6)2 + (6 −5)2 = √5 PQ QR PR PQR is not isosceles"],
    finalAnswer: "( 16 3 , 16 3 ) (iii) PQ = √(4 −3)2 + (6 −2)2 = √17 QR = √(3 −6)2 + (2 −5)2 = √18 PR = √(4 −6)2 + (6 −5)2 = √5 PQ QR PR PQR is not isosceles",
