...
export const COORDINATE_GEOMETRY_PYQ: CanonicalQuestion[] = [
  { id: "PYQ-M-CG-001", subject: "Maths", topicKey: "coordinate-geometry", subtopic: "Coordinates of Vertices", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Applying",
    ...
    answer: "(3, 4)",
    solutionSteps: ["Correct option: (c) (3, 4)."],
    finalAnswer: "(c) (3, 4)",
  ...
  { id: "PYQ-M-CG-007", subject: "Maths", topicKey: "coordinate-geometry", subtopic: "General", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Analysing",
    ...
    answer: "To prove: ∠ OPA = ∠ OPB Construction: Join OA, OB Proof: In Δ OPA and Δ OPB OP = OP (common) OA = OA (radii) ∠ OAP = ∠ OBP (each 90°, radius ⊥ tangents) ∴ Δ OPA ≅ Δ OPB (RHS) ⇒ ∠ OPA = ∠ OPB (CPCT) 1 mark for correct figure",
    solutionSteps: ["Given : PA and PB are tangents drawn from an external point P to the circle with centre O.", "To prove: ∠ OPA = ∠ OPB Construction: Join OA, OB Proof: In Δ OPA and Δ OPB OP = OP (common) OA = OA (radii) ∠ OAP = ∠ OBP (each 90°, radius ⊥ tangents) ∴ Δ OPA ≅ Δ OPB (RHS) ⇒ ∠ OPA = ∠ OPB (CPCT) 1 mark for correct figure"],
    finalAnswer: "To prove: ∠ OPA = ∠ OPB Construction: Join OA, OB Proof: In Δ OPA and Δ OPB OP = OP (common) OA = OA (radii) ∠ OAP = ∠ OBP (each 90°, radius ⊥ tangents) ∴ Δ OPA ≅ Δ OPB (RHS) ⇒ ∠ OPA = ∠ OPB (CPCT) 1 mark for correct figure",
