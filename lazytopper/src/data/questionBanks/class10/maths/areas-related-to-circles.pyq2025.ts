...
export const AREAS_RELATED_TO_CIRCLES_PYQ_2025: CanonicalQuestion[] = [
  ...
  { id: "PYQ-M-2025-ARC-003", subject: "Maths", topicKey: "areas-related-to-circles", subtopic: "Area of Sector", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Applying",
    questionText: "If the area of a sector of circle of radius 36 cm is 54 cm2, then the length of the corresponding arc of the sector is :",
    options: ["8 cm", "6 cm", "4 cm", "3 cm"],
    answer: "3π cm",
    solutionSteps: ["Correct option: (d) 3π cm."],
    finalAnswer: "(d) 3π cm",
  ...
  { id: "PYQ-M-2025-ARC-004", subject: "Maths", topicKey: "areas-related-to-circles", subtopic: "Area of Sector", section: "E", marks: 4, format: "Case-Based", difficulty: "Hard", bloomSkill: "Applying",
    ...
    answer: "(i) central angle = 3600 10 = 36° (ii) length of arc ACB = 1 10 × 2 × 22 7 × 35 2 = 11mm (iii)(a) Area of each sector of the brooch = 1 10 × 22 7 × 35 2 × 35 2 = 385 4 mm2 or 96.25 mm2 OR (iii) (b) length of silver wire used = 2 × 22 7 × 35 2 + 5 × 35 = 285 mm",
    solutionSteps: ["(i) central angle = 3600 10 = 36° (ii) length of arc ACB = 1 10 × 2 × 22 7 × 35 2 = 11mm (iii)(a) Area of each sector of the brooch = 1 10 × 22 7 × 35 2 × 35 2 = 385 4 mm2 or 96.25 mm2 OR (iii) (b) length of silver wire used = 2 × 22 7 × 35 2 + 5 × 35 = 285 mm"],
    finalAnswer: "(i) central angle = 3600 10 = 36° (ii) length of arc ACB = 1 10 × 2 × 22 7 × 35 2 = 11mm (iii)(a) Area of each sector of the brooch = 1 10 × 22 7 × 35 2 × 35 2 = 385 4 mm2 or 96.25 mm2 OR (iii) (b) length of silver wire used = 2 × 22 7 × 35 2 + 5 × 35 = 285 mm",
