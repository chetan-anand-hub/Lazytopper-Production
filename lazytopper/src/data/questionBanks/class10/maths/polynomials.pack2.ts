  ...
  },
{
  ...
  { id: "PL2-R18", subject: "Maths", topicKey: "Polynomials", subtopic: "Division Algorithm", section: "A", marks: 1, format: "MCQ", difficulty: "Easy", bloomSkill: "Remembering", questionText: "If p(x) = q(x)·g(x) + r(x), then:", options: ["degree r < degree g","degree r = degree g","degree r > degree g","degree r = degree p"], answer: "degree r < degree g", explanation: "The correct answer is degree r < degree g. The Division Algorithm for polynomials requires the degree of remainder to be less than the degree of divisor.", finalAnswer: "The Division Algorithm for polynomials requires the degree of remainder to be less than the degree of divisor.", isCompetencyBased: false },
