...
export const TRIANGLES_PYQ_2024: CanonicalQuestion[] = [
  ...
  { id: "PYQ-M-2024-TRI-002", subject: "Maths", topicKey: "triangles", subtopic: "General", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Applying",
    ...
    pyqYear: "2024", pyqSet: "1" },
  { id: "PYQ-M-2024-TRI-003b", subject: "Maths", topicKey: "triangles", subtopic: "General", section: "B", marks: 2, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    questionText: "A(3, 0), B(6, 4) and C(–1, 3) are vertices of a triangle ABC. Find lengthofitsmedianBE.",
    answer: "Midpoint of AC is 𝐸(1, 3 2) Length of median BE = √(6 −1)2 + (4 − 3 2)2 = √125 4 or 5√5",
    solutionSteps: ["Midpoint of AC is 𝐸(1, 3 2) Length of median BE = √(6 −1)2 + (4 − 3 2)2 = √125 4 or 5√5"],
    finalAnswer: "Midpoint of AC is 𝐸(1, 3 2) Length of median BE = √(6 −1)2 + (4 − 3 2)2 = √125 4 or 5√5",
    ncertRef: "PYQ 30/2/1 Q25(b)", isCompetencyBased: true,
    pyqYear: "2024", pyqSet: "1" },
  { id: "PYQ-M-2024-TRI-004a", subject: "Maths", topicKey: "triangles", subtopic: "General", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    questionText: "A circle is inscribed in a rightangled triangle ABC, rightangled at B. If BC = 7 cm and AB = 24 cm, find the radius of the circle.",
    answer: "r = 3 ∴ radius of circle is 3 cm.",
    solutionSteps: ["𝐴𝐶= √242 + 72 = 25 cm Let the radius of the circle be 'r' cm 1 2 × 24 × 7 = 1 2 × 𝑟× 7 + 1 2 × 𝑟× 24 + 1 2 × 𝑟× 25", "r = 3 ∴ radius of circle is 3 cm."],
    finalAnswer: "r = 3 ∴ radius of circle is 3 cm.",
