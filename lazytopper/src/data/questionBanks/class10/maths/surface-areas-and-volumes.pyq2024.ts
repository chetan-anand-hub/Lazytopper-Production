...
export const SURFACE_AREAS_AND_VOLUMES_PYQ_2024: CanonicalQuestion[] = [
  ...
  { id: "PYQ-M-2024-SAV-002", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Surface Area of Solids", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Applying",
    ...
    options: ["2p : 1", "4p : 1", "3p : 1", "1 : 4p 1430/4/1"],
    answer: "3π:1",
  ...
  { id: "PYQ-M-2024-SAV-003", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Surface Area of Solids", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Applying",
    questionText: "Two identical solid cubes of side 'a' are joined endtoend. The total surface area of the resulting cuboid is :",
    options: ["6a2", "10a2", "5a2", "4a2"],
    answer: "10𝑎2 1",
    solutionSteps: ["Correct option: (b) 10𝑎2 1."],
    finalAnswer: "(b) 10𝑎2 1",
  ...
  { id: "PYQ-M-2024-SAV-004a", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Combination of Solids", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    questionText: "The interior of a building is in the form of a cylinder of base radius 12 m and height 3×5 m surmounted by a cone of equal base and slant height 14 m. Find the internal curved surface area of the building. OR 1430(B)",
    answer: "Internal CSA of the building = 2 × 22 7 × 12 × 3.5 + 22 7 × 12 × 14 = 792 m2 2 + 2",
    solutionSteps: ["Internal CSA of the building = 2 × 22 7 × 12 × 3.5 + 22 7 × 12 × 14 = 792 m2 2 + 2"],
    finalAnswer: "Internal CSA of the building = 2 × 22 7 × 12 × 3.5 + 22 7 × 12 × 14 = 792 m2 2 + 2",
  ...
  { id: "PYQ-M-2024-SAV-005", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Combination of Solids", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    ...
    answer: "CSA of cylinder = 2 × 22 7 × 2.1 × 5.8 = 76.56 cm2 CSA of two hemisphere = 4 × 22 7 × 2.1 × 2.1 = 55.44 cm2 Total Surface Area of article = 76.56 + 55.44 = 132 cm2 1 1 1 1 1 SECTIONE This section comprises 3 case study based questions of 4 marks each.",
    solutionSteps: ["CSA of cylinder = 2 × 22 7 × 2.1 × 5.8 = 76.56 cm2 CSA of two hemisphere = 4 × 22 7 × 2.1 × 2.1 = 55.44 cm2 Total Surface Area of article = 76.56 + 55.44 = 132 cm2 1 1 1 1 1 SECTIONE This section comprises 3 case study based questions of 4 marks each."],
    finalAnswer: "CSA of cylinder = 2 × 22 7 × 2.1 × 5.8 = 76.56 cm2 CSA of two hemisphere = 4 × 22 7 × 2.1 × 2.1 = 55.44 cm2 Total Surface Area of article = 76.56 + 55.44 = 132 cm2 1 1 1 1 1 SECTIONE This section comprises 3 case study based questions of 4 marks each.",
  ...
  { id: "PYQ-M-2024-SAV-006", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Volume of Solids", section: "E", marks: 4, format: "Case-Based", difficulty: "Hard", bloomSkill: "Applying",
    questionText: "Tamperproof tetrapacked milk guarantees both freshness and security. This milk ensures uncompromised quality, preserving the nutritional values within and making it a reliable choice for healthconscious individuals. 500 mL milk is packed in a cuboidal container of dimensions 15 cm ´ 8 cm ´ 5 cm. These milk packets are then packed in cuboidal cartons of dimensions 30 cm ´ 32 cm ´ 15 cm. Based on the above given information, answer the following questions : (i) Find the volume of the cuboidal carton. 1 (ii) (a) Find the total surface area of a milk packet. 2 OR (b) How many milk packets can be filled in a carton ? 2 (iii) How much milk can the cup (as shown in the figure) hold ?",
    answer: "(i) Volume of cuboidal carton = 30×32×15 = 14400 cm3 (ii)(a) Total surface area of milk packet = 2(15×8+8×5+5×15) = 470 cm2 OR (ii) (b) Number of milk packets in carton = 30×32×15 15×8×5 = 24 (iii) Capacity of the cup = 22 7 × 5 × 5 × 7 = 550 𝑐𝑚3 or 550 ml",
    solutionSteps: ["(i) Volume of cuboidal carton = 30×32×15 = 14400 cm3 (ii)(a) Total surface area of milk packet = 2(15×8+8×5+5×15) = 470 cm2 OR (ii) (b) Number of milk packets in carton = 30×32×15 15×8×5 = 24 (iii) Capacity of the cup = 22 7 × 5 × 5 × 7 = 550 𝑐𝑚3 or 550 ml"],
    finalAnswer: "(i) Volume of cuboidal carton = 30×32×15 = 14400 cm3 (ii)(a) Total surface area of milk packet = 2(15×8+8×5+5×15) = 470 cm2 OR (ii) (b) Number of milk packets in carton = 30×32×15 15×8×5 = 24 (iii) Capacity of the cup = 22 7 × 5 × 5 × 7 = 550 𝑐𝑚3 or 550 ml",
