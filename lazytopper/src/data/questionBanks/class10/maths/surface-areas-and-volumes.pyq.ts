...
export const SURFACE_AREAS_AND_VOLUMES_PYQ: CanonicalQuestion[] = [
  ...
  { id: "PYQ-M-SAV-002", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Combination of Solids", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    ...
    solutionSteps: ["Radius of each cone = Radius of cylinder = 2 3 cm Height of each cone 'H' = 2 cm Height of cylinder 'h' = 12 – 4 = 8 cm Volume of air = Volume of cylinder + Volume of 2 cones = r2h + 2 3 1 r2H = r2     + H 3 2 h = 7 22  2 3  2 3     + 2 3 2 8 = 7 22  4 9  3 28 = 66 cm3 1 1 𝟏 𝟐+1"],
    finalAnswer: "Radius of each cone = Radius of cylinder = 2 3 cm Height of each cone 'H' = 2 cm Height of cylinder 'h' = 12 – 4 = 8 cm Volume of air = Volume of cylinder + Volume of 2 cones = r2h + 2 3 1 r2H = r2     + H 3 2 h = 7 22  2 3  2 3     + 2 3 2 8 = 7 22  4 9  3 28 = 66 cm3 1 1 𝟏 𝟐+1",
  ...
  { id: "PYQ-M-SAV-003", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Surface Area of Solids", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    ...
    solutionSteps: ["Height of cylinder h = 20 cm radius of cylinder = 6 cm = Radius of cone Height of cone = 8 cm Slant height l = 2 2 6 8 + = 36 64 + = 10 cm Surface area of remaining solid = CSA of cylinder + CSA of cone + Area of base of cylinder = 2rh + rl + r2 = r[2h + l + r] = 7 22  6[2  20 + 10 + 6] = 7 22  6  56 = 1056 cm2 𝟏 𝟐 1 1+1+1"],
    finalAnswer: "Height of cylinder h = 20 cm radius of cylinder = 6 cm = Radius of cone Height of cone = 8 cm Slant height l = 2 2 6 8 + = 36 64 + = 10 cm Surface area of remaining solid = CSA of cylinder + CSA of cone + Area of base of cylinder = 2rh + rl + r2 = r[2h + l + r] = 7 22  6[2  20 + 10 + 6] = 7 22  6  56 = 1056 cm2 𝟏 𝟐 1 1+1+1",
  ...
  { id: "PYQ-M-SAV-004", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Combination of Solids", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    ...
    solutionSteps: ["Height of cylinder = 10 cm 16  Radius of cylinder = radius of hemisphere = 3·5 = 2 7 cm Total surface area of the article = CSA of cylinder + CSA of 2 hemispheres = 2rh + 2 × 2r2 = 2r(h + 2r) = 2 × 7 22 × 2 7 (10 + 2 × 2 7 ) = 22 × 17 = 374 cm2 1 1 𝟏 𝟐+1"],
    finalAnswer: "Height of cylinder = 10 cm 16  Radius of cylinder = radius of hemisphere = 3·5 = 2 7 cm Total surface area of the article = CSA of cylinder + CSA of 2 hemispheres = 2rh + 2 × 2r2 = 2r(h + 2r) = 2 × 7 22 × 2 7 (10 + 2 × 2 7 ) = 22 × 17 = 374 cm2 1 1 𝟏 𝟐+1",
  ...
  { id: "PYQ-M-SAV-005", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Surface Area of Solids", section: "E", marks: 4, format: "Case-Based", difficulty: "Hard", bloomSkill: "Applying",
    ...
    solutionSteps: ["(i) Area of base of the cylindrical cup = 22 7 × 7 2 × 7 2 = 77 2 or 38.5 ∴ Area of base of the cylindrical cup is 77 2 or 38.5 cm2 (ii) (a) Capacity of hemispherical cup = 2 3 × 22 7 × 21 2 × 21 2 × 21 2 = 4851 2 or 2425.5 ∴ Capacity of hemispherical cup is 4851 2 cm3 or 2425.5 cm3 OR (ii) (b) Capacity of cylindrical cup = 22 7 × (7)2 × 14 = 539 ∴ Capacity of cylindrical cup is 539 cm3 (iii) External Curved surface area of cylindrical cup = 2 × 22 7 × 7 2 ×14 = 308 ∴ External Curved surface area of cylindrical cup is 308 cm2"],
    finalAnswer: "(i) Area of base of the cylindrical cup = 22 7 × 7 2 × 7 2 = 77 2 or 38.5 ∴ Area of base of the cylindrical cup is 77 2 or 38.5 cm2 (ii) (a) Capacity of hemispherical cup = 2 3 × 22 7 × 21 2 × 21 2 × 21 2 = 4851 2 or 2425.5 ∴ Capacity of hemispherical cup is 4851 2 cm3 or 2425.5 cm3 OR (ii) (b) Capacity of cylindrical cup = 22 7 × (7)2 × 14 = 539 ∴ Capacity of cylindrical cup is 539 cm3 (iii) External Curved surface area of cylindrical cup = 2 × 22 7 × 7 2 ×14 = 308 ∴ External Curved surface area of cylindrical cup is 308 cm2",
