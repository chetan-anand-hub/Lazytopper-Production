...
export const STATISTICS_PYQ_2025: CanonicalQuestion[] = [
  ...
  { id: "PYQ-M-2025-STAT-002", subject: "Maths", topicKey: "statistics", subtopic: "Mode", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    ...
    solutionSteps: ["[2 marks] Correct table (step-deviation, a = 135, h = 20) — Monthly Consumption | fi | xi | ui = (xi − 135)/20 | fiui: 65–85 | 4 | 75 | −3 | −12; 85–105 | 5 | 95 | −2 | −10; 105–125 | 13 | 115 | −1 | −13; 125–145 | 20 | 135 = a | 0 | 0; 145–165 | 14 | 155 | 1 | 14; 165–185 | 8 | 175 | 2 | 16; 185–205 | 4 | 195 | 3 | 12; Total: Σfi = 68, Σfiui = 7.", "[1 mark] Mean = a + (Σfiui/Σfi) × h = 135 + (7/68) × 20 = 137.06.", "[0.5 mark] Modal class is 125–145 (highest frequency 20).", "[1 mark] Mode = 125 + ((20 − 13)/(2×20 − 13 − 14)) × 20 = 125 + (7/13) × 20 = 135.77.", "[0.5 mark] Hence Mean = 137.06 units and Mode = 135.77 units."],
    finalAnswer: "Mean = 137.06 units and Mode = 135.77 units",
  ...
  { id: "PYQ-M-2025-STAT-003", subject: "Maths", topicKey: "statistics", subtopic: "Median", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    ...
    solutionSteps: ["[2 marks] Correct table with continuous class limits — Length (mm) | fi | cf: 117.5–126.5 | 3 | 3; 126.5–135.5 | 5 | 8; 135.5–144.5 | 9 | 17; 144.5–153.5 | 12 | 29; 153.5–162.5 | 5 | 34; 162.5–171.5 | 4 | 38; 171.5–180.5 | 2 | 40. N = 40, so N/2 = 20.", "[1 mark] Median class = 144.5–153.5 (first class with cf ≥ 20).", "[1 mark] Median = l + ((N/2 − cf)/f) × h = 144.5 + ((20 − 17)/12) × 9.", "[0.5 mark] = 144.5 + 2.25 = 146.75.", "[0.5 mark] Hence, the median length of the leaves is 146.75 mm."],
  ...
  { id: "PYQ-M-2025-STAT-004", subject: "Maths", topicKey: "statistics", subtopic: "Median", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    ...
    answer: "Mean = 970/25 = 38.8; median class 35–45; Median = 35 + ((12.5 − 10)/7) × 10 = 270/7 ≈ 38.57",
    solutionSteps: ["[2 marks] Correct table — Classes | fi | xi | fixi | cf: 5–15 | 2 | 10 | 20 | 2; 15–25 | 3 | 20 | 60 | 5; 25–35 | 5 | 30 | 150 | 10; 35–45 | 7 | 40 | 280 | 17; 45–55 | 4 | 50 | 200 | 21; 55–65 | 2 | 60 | 120 | 23; 65–75 | 2 | 70 | 140 | 25; Total: Σfi = 25, Σfixi = 970.", "[1 mark] Mean = Σfixi/Σfi = 970/25 = 38.8.", "[0.5 mark] N/2 = 25/2 = 12.5 ⟹ median class is 35–45 (first class with cf ≥ 12.5).", "[1 mark] Median = 35 + ((12.5 − 10)/7) × 10 = 35 + 25/7 = 270/7.", "[0.5 mark] Hence Mean = 38.8 and Median = 270/7 or 38.57 (approx.)."],
    finalAnswer: "Mean = 970/25 = 38.8; median class 35–45; Median = 35 + ((12.5 − 10)/7) × 10 = 270/7 ≈ 38.57",
  ...
  { id: "PYQ-M-2025-STAT-005", subject: "Maths", topicKey: "statistics", subtopic: "Mode", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    ...
    answer: "Step-deviation table with a = 22, h = 4: Σfi = 100, Σfiui = −52; Mean = 22 + (−52/100) × 4 = 19.92; modal class 16–20; Mode = 16 + ((25 − 15)/(2×25 − 15 − 18)) × 4 = 312/17 ≈ 18.35",
    solutionSteps: ["[2 marks] Correct table (step-deviation, a = 22, h = 4) — Class | fi | xi | ui = (xi − 22)/4 | fiui: 4–8 | 2 | 6 | −4 | −8; 8–12 | 12 | 10 | −3 | −36; 12–16 | 15 | 14 | −2 | −30; 16–20 | 25 | 18 | −1 | −25; 20–24 | 18 | 22 = a | 0 | 0; 24–28 | 12 | 26 | 1 | 12; 28–32 | 13 | 30 | 2 | 26; 32–36 | 3 | 34 | 3 | 9; Total: Σfi = 100, Σfiui = −52.", "[1 mark] Mean = a + (Σfiui/Σfi) × h = 22 + (−52/100) × 4 = 19.92.", "[0.5 mark] Modal class is 16–20 (highest frequency 25).", "[1 mark] Mode = 16 + ((25 − 15)/(2×25 − 15 − 18)) × 4 = 16 + (10/17) × 4 = 312/17.", "[0.5 mark] Hence Mean = 19.92 and Mode = 312/17 or 18.35 (approx.)."],
    finalAnswer: "Step-deviation table with a = 22, h = 4: Σfi = 100, Σfiui = −52; Mean = 22 + (−52/100) × 4 = 19.92; modal class 16–20; Mode = 16 + ((25 − 15)/(2×25 − 15 − 18)) × 4 = 312/17 ≈ 18.35",
  ...
  { id: "PYQ-M-2025-STAT-006", subject: "Maths", topicKey: "statistics", subtopic: "Median", section: "E", marks: 4, format: "Case-Based", difficulty: "Hard", bloomSkill: "Applying",
    ...
    answer: "(i) Modal class = 600–800 (ii) (a) N = 24, median class 600–800; Median = 600 + ((12 − 7)/7) × 200 = 5200/7 ≈ 742.8 mm OR (b) Σfi = 24, Σfixi = 18600; Mean = 18600/24 = 775 mm (iii) 4 + 3 + 3 = 10 subdivisions",
    solutionSteps: ["[1 mark] (i) Modal class = 600–800 (highest number of subdivisions, 7).", "[1 mark] (ii)(a) cf table — Rainfall (mm) | fi | cf: 200–400 | 3 | 3; 400–600 | 4 | 7; 600–800 | 7 | 14; 800–1000 | 4 | 18; 1000–1200 | 3 | 21; 1200–1400 | 3 | 24. N = 24, N/2 = 12 ⟹ Median class = 600–800. [OR (ii)(b): fixi table — 3×300 + 4×500 + 7×700 + 4×900 + 3×1100 + 3×1300; Σfi = 24, Σfixi = 18600.]", "[1 mark] (ii)(a) Median = 600 + ((12 − 7)/7) × 200 = 5200/7 or 742.8 mm (approx.). [OR (ii)(b): Mean = 18600/24 = 775 ⟹ mean rainfall = 775 mm.]", "[1 mark] (iii) Subdivisions with at least 800 mm rainfall = 4 + 3 + 3 = 10."],
    finalAnswer: "(i) Modal class = 600–800 (ii) (a) N = 24, median class 600–800; Median = 600 + ((12 − 7)/7) × 200 = 5200/7 ≈ 742.8 mm OR (b) Σfi = 24, Σfixi = 18600; Mean = 18600/24 = 775 mm (iii) 4 + 3 + 3 = 10 subdivisions",
