...
export const REAL_NUMBERS_PACK1: CanonicalQuestion[] = [
  ...
  },
  {
      ...
      solutionSteps: [
        "Assume √7 = p/q where p, q are co-prime integers, q ≠ 0.",
        "Squaring: 7 = p²/q², so p² = 7q².",
        "7 divides p², and since 7 is prime, 7 divides p. Let p = 7k.",
        "Then 49k² = 7q², so q² = 7k². Thus 7 divides q.",
        "Both p and q divisible by 7 contradicts co-prime assumption.",
  ...
  },
  {
      ...
      solutionSteps: [
        "Assume 5 − √3 is rational, say 5 − √3 = r where r is rational.",
        "Then √3 = 5 − r.",
  ...
  },
  {
      ...
      solutionSteps: [
        "(i) 30 = 2 × 3 × 5; 45 = 3² × 5; 60 = 2² × 3 × 5. LCM = 2² × 3² × 5 = 180 seconds.",
        "(ii) 180 seconds.",
        "(iii) 9:00 AM + 3 minutes = 9:03 AM.",
        "(iv) From 9:00 to 10:00 = 3600 seconds. 3600 ÷ 180 = 20 times."
      ],
  ...
  },
  {
      ...
      solutionSteps: [
        "Part 1: Assume 3 + √5 = r (rational).",
        "Then √5 = r − 3, which is rational. But √5 is irrational. Contradiction.",
