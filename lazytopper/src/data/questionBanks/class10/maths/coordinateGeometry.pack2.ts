...
export const CG2_PACK2: CanonicalQuestion[] = [
  ...
  { id: "CG2-049", subject: "Maths", topicKey: "Coordinate Geometry", subtopic: "Distance Formula", section: "A", marks: 1, format: "MCQ", difficulty: "Easy", bloomSkill: "Remembering", questionText: "The distance between the points (a, 0) and (0, b) is:", options: ["√(a²+b²)","a+b","|a−b|","√(a²−b²)"], answer: "√(a²+b²)", explanation: "The correct answer is √(a²+b²). d = √((a−0)²+(0−b)²) = √(a²+b²).", finalAnswer: "d = √((a−0)²+(0−b)²) = √(a²+b²).", isCompetencyBased: false,
    solutionSteps: [
      "Identify the coordinates: (x1, y1) = (2, 3) and (x2, y2) = (4, 1).",
      "Apply the distance formula: d = sqrt[(x2-x1)^2 + (y2-y1)^2].",
      "Substitute values: d = sqrt[(4-2)^2 + (1-3)^2] = sqrt[2^2 + (-2)^2] = sqrt[4+4] = sqrt[8].",
      "Simplify: d = 2sqrt(2) units. This matches option (B).",
    ],
  },
  { id: "CG2-050", subject: "Maths", topicKey: "Coordinate Geometry", subtopic: "Section Formula", section: "A", marks: 1, format: "MCQ", difficulty: "Easy", bloomSkill: "Remembering", questionText: "The point which divides the segment joining (1, 3) and (4, 6) in ratio 1:2 internally is:", options: ["(2, 4)","(3, 5)","(2.5, 4.5)","(1.5, 3.5)"], answer: "(2, 4)", explanation: "The correct answer is (2, 4). P = ((1×4+2×1)/3, (1×6+2×3)/3) = (6/3, 12/3) = (2, 4).", finalAnswer: "P = ((1×4+2×1)/3, (1×6+2×3)/3) = (6/3, 12/3) = (2, 4).", isCompetencyBased: false,
    solutionSteps: [
      "Identify points A(x1, y1)=(1, -3), B(x2, y2)=(4, 6) and ratio m1:m2 = 1:2.",
      "Apply the section formula for x-coordinate: x = (m1x2 + m2x1) / (m1+m2).",
      "Substitute values for x: x = (1*4 + 2*1) / (1+2) = (4+2)/3 = 6/3 = 2.",
      "Apply the section formula for y-coordinate: y = (m1y2 + m2y1) / (m1+m2).",
      "Substitute values for y: y = (1*6 + 2*(-3)) / (1+2) = (6-6)/3 = 0/3 = 0.",
  ...
  { id: "CG2-052", subject: "Maths", topicKey: "Coordinate Geometry", subtopic: "Area of Triangle", section: "A", marks: 1, format: "MCQ", difficulty: "Easy", bloomSkill: "Remembering", questionText: "The area of the triangle with vertices (0,0), (6,0) and (0,4) is:", options: ["12 sq units","24 sq units","8 sq units","6 sq units"], answer: "12 sq units", explanation: "The correct answer is 12 sq units. Area = ½ × base × height = ½ × 6 × 4 = 12 sq units.", finalAnswer: "Area = ½ × base × height = ½ × 6 × 4 = 12 sq units.", isCompetencyBased: false,
    solutionSteps: [
      ...
      "Assuming vertices are (1, -1), (-4, 6), (-3, -5): Area = 1/2 |1(6 - (-5)) + (-4)(-5 - (-1)) + (-3)(-1 - 6)|.",
      "Calculate: 1/2 |1(11) + (-4)(-4) + (-3)(-7)| = 1/2 |11 + 16 + 21| = 1/2 |48| = 24.",
    ],
  },
  { id: "CG2-053", subject: "Maths", topicKey: "Coordinate Geometry", subtopic: "Section Formula", section: "A", marks: 1, format: "MCQ", difficulty: "Easy", bloomSkill: "Remembering", questionText: "The midpoint of (−3, 4) and (5, −2) is:", options: ["(1, 1)","(1, 2)","(2, 1)","(0, 1)"], answer: "(1, 1)", explanation: "The correct answer is (1, 1). Midpoint = ((−3+5)/2, (4+(−2))/2) = (2/2, 2/2) = (1, 1).", finalAnswer: "Midpoint = ((−3+5)/2, (4+(−2))/2) = (2/2, 2/2) = (1, 1).", isCompetencyBased: false,
    solutionSteps: [
      "The coordinates of a point P(x,y) dividing a line segment joining (x1,y1) and (x2,y2) in ratio m1:m2 internally are x = (m1x2+m2x1)/(m1+m2), y = (m1y2+m2y1)/(m1+m2).",
      "Assuming points A(4, -3) and B(8, 5) and ratio 3:1: x = (3*8 + 1*4)/(3+1), y = (3*5 + 1*(-3))/(3+1).",
      "Calculate: x = (24+4)/4 = 28/4 = 7; y = (15-3)/4 = 12/4 = 3. The point is (7,3).",
    ],
  },
  { id: "CG2-054", subject: "Maths", topicKey: "Coordinate Geometry", subtopic: "Distance Formula", section: "A", marks: 1, format: "MCQ", difficulty: "Easy", bloomSkill: "Remembering", questionText: "If A(2, y) and B(6, 4) and AB = 5, then y equals:", options: ["1 or 7","0 or 8","1 or −7","7 only"], answer: "1 or 7", explanation: "The correct answer is 1 or 7. AB² = 16+(y−4)² = 25 → (y−4)² = 9 → y−4 = ±3 → y = 7 or y = 1.", finalAnswer: "AB² = 16+(y−4)² = 25 → (y−4)² = 9 → y−4 = ±3 → y = 7 or y = 1.", isCompetencyBased: false,
    solutionSteps: [
      ...
      "Assuming points P(2, -3) and Q(10, 3): d = sqrt((10-2)^2 + (3-(-3))^2).",
      "Calculate: d = sqrt((8)^2 + (6)^2) = sqrt(64 + 36) = sqrt(100) = 10.",
    ],
  },
  { id: "CG2-055", subject: "Maths", topicKey: "Coordinate Geometry", subtopic: "Distance Formula", section: "A", marks: 1, format: "Assertion-Reasoning", difficulty: "Medium", bloomSkill: "Analysing", questionText: "Assertion (A): The distance of the point (3, 4) from the origin is 5.\nReason (R): The distance formula between (x₁, y₁) and (x₂, y₂) is √((x₂−x₁)²+(y₂−y₁)²).", options: ["Both A and R are true, and R is the correct explanation of A.","Both A and R are true, but R is not the correct explanation of A.","A is true, R is false.","A is false, R is true."], answer: "Both A and R are true, and R is the correct explanation of A.", explanation: "d = √(3²+4²) = √25 = 5. R gives the formula used to compute A.", finalAnswer: "Both A and R are true, and R is the correct explanation of A.", isCompetencyBased: true,
    solutionSteps: [
      "To check Assertion (A): The distance of P(3, -4) from the origin (0, 0) is calculated using the distance formula.",
      "Distance = sqrt((3-0)^2 + (-4-0)^2) = sqrt(3^2 + (-4)^2) = sqrt(9 + 16) = sqrt(25) = 5 units. So, Assertion (A) is true.",
      "To check Reason (R): The distance of a point (x, y) from the origin is given by sqrt(x^2 + y^2), which is a standard formula. So, Reason (R) is true.",
