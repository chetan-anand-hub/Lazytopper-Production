...
export const SURFACE_AREAS_AND_VOLUMES_PYQ_2026: CanonicalQuestion[] = [
  ...
  { id: "PYQ-M-2026-SAV-002", subject: "Maths", topicKey: "surface-areas-and-volumes", subtopic: "Surface Area of Solids", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Applying",
    ...
    solutionSteps: ["Height of cylinder (h) = 2.8 cm Radius of cylinder (r) = 2.1 cm Volume of remaining solid = 22 7 × 2.1 × 2.1× 2.8 – 1 3 × 22 7 × 2.1 × 2.1 × 2.8 = 25.872 cm3 Slant height (l) = √(2.1)2 + (2.8)2 = 3.5 cm Total surface area of the remaining solid = 2 × 22 7 × 2.1 × 2.8 + 22 7 × 2.1 × 3.5 + 22 7 × 2.1 × 2.1 = 73.92 cm2"],
