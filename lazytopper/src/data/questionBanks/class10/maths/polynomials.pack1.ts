  ...
  },
{
    ...
    solutionSteps: [
      "Sum = 3 + (−1) = 2 [½]",
      "Product = 3 × (−1) = −3 [½]",
      "Polynomial = x² − (sum)x + product = x² − 2x − 3 [1]",
    ],
    finalAnswer: "x² − 2x − 3",
  ...
  },
{
    ...
    solutionSteps: [
      ...
      "Polynomial = x² − (−3/4)x + (−1/4) = x² + 3x/4 − 1/4 [½]",
      "Multiply by 4: 4x² + 3x − 1 [1]",
    ],
    finalAnswer: "4x² + 3x − 1",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  },
{
    ...
    solutionSteps: [
      "α + β = 5/2, αβ = 7/2 [1]",
      "α² + β² = (α + β)² − 2αβ = 25/4 − 7 = 25/4 − 28/4 = −3/4 [1]",
    ],
    finalAnswer: "−3/4",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  },
{
    ...
    solutionSteps: [
      "A quadratic polynomial is k[x² - (sum of zeroes)x + (product of zeroes)]. [1]",
      "Substituting, P(x) = k[x² - (-3)x + 2] = k(x² + 3x + 2). (Take k=1). [1]",
    ],
    finalAnswer: "x² + 3x + 2",
    visualExplainerId: "maths-polynomials-relationship-between-zeroes-and-coefficients", isCompetencyBased: true,
  },
{
    ...
    solutionSteps: [
      "α + β = −2/3, αβ = −6/3 = −2 [1]",
      "(i) α/β + β/α = (α² + β²)/(αβ) = [(α+β)² − 2αβ]/αβ = [4/9 + 4]/(−2) = [40/9]/(−2) = −20/9 [1]",
      "(ii) α³ + β³ = (α+β)(α² − αβ + β²) = (−2/3)(40/9 − (−2)) = (−2/3)(40/9 + 2) = (−2/3)(58/9) = −116/27 [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "(x − √2)(x + √2) = x² − 2 is a factor; Divide: 2x⁴ − 3x³ − 3x² + 6x − 2 ÷ (x² − 2) = 2x² − 3x + 1 [½]",
      "2x² − 3x + 1 = (2x − 1)(x − 1) [½]",
      "All zeroes: √2, −√2, 1/2, 1 [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "Since x = 1 is a zero, (x − 1) is a factor.; Divide: x³ − 6x² + 11x − 6 ÷ (x − 1) = x² − 5x + 6 [1]",
      "x² − 5x + 6 = (x − 2)(x − 3) [1]",
      "All zeroes: 1, 2, 3 [1]",
    ],
    finalAnswer: "1, 2, 3",
  ...
  },
{
    ...
    solutionSteps: [
      "Zeroes of 2x² − 5x − 3: sum = 5/2, product = −3/2; 2x² − 5x − 3 = (2x + 1)(x − 3), zeroes: −1/2 and 3 [½]",
      "Doubled zeroes: −1 and 6; p = −(sum) = −(−1 + 6) = −5 [½]",
      "q = product = (−1)(6) = −6 [1]",
    ],
    finalAnswer: "p = −5, q = −6",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  ...
  },
{
    ...
    solutionSteps: [
      "α + β = 1, αβ = −2; New sum = (2α + 1) + (2β + 1) = 2(α + β) + 2 = 2 + 2 = 4 [1]",
      "New product = (2α + 1)(2β + 1) = 4αβ + 2(α + β) + 1 = −8 + 2 + 1 = −5 [1]",
      "Polynomial = x² − 4x − 5 [1]",
    ],
    finalAnswer: "x² − 4x − 5",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  },
{
    ...
    solutionSteps: [
      "(i) −x² + 4x − 3 = 0 ⟹ x² − 4x + 3 = 0 ⟹ (x−1)(x−3) = 0, zeroes: 1, 3 [1]",
      "(ii) Vertex x = −b/(2a) = −4/(−2) = 2, p(2) = −4 + 8 − 3 = 1, max height = 1 [1]",
      "(iii) x = 2 [1]",
      "(iv) Downward (a = −1 < 0) [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "3x² − x − 4 = (3x − 4)(x + 1); Zeroes: 4/3 and −1 [½]",
      "Sum = 4/3 − 1 = 1/3 = −(−1)/3 ✓ [½]",
      "Product = (4/3)(−1) = −4/3 = −4/3 ✓ [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "α + β = −1/6, αβ = −2/6 = −1/3; α/β + β/α = (α²+β²)/(αβ) = [(α+β)² − 2αβ]/(αβ) = [1/36 + 2/3]/(−1/3) = [25/36]/(−1/3) = −25/12 [1]",
      "1/α + 1/β = (α+β)/(αβ) = (−1/6)/(−1/3) = 1/2 [1]",
      "Result = −25/12 + 2(1/2) + 3(−1/3) = −25/12 + 1 − 1 = −25/12 [1]",
    ],
    finalAnswer: "−25/12",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  },
{
    ...
    solutionSteps: [
      "(i) Zeroes where p(x) = 0: x = −2 and x = 2, so 2 zeroes [1]",
      "(ii) p(0) = −8 [1]",
      "(iii) At least quadratic (2 zeroes) [1]",
      "(iv) p(x) = a(x+2)(x−2) = a(x²−4). p(0) = −4a = −8 ⟹ a = 2. p(x) = 2x² − 8. Check: p(4) = 32−8 = 24 ✓ [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "α + β = k + 6, αβ = 2(2k−1) = 4k − 2 [½]",
      "Given: k + 6 = (4k−2)/2 = 2k − 1 [½]",
      "k + 6 = 2k − 1 ⟹ k = 7 [1]",
    ],
    finalAnswer: "k = 7",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  ...
  },
{
    ...
    solutionSteps: [
      "(x − √(5/3))(x + √(5/3)) = x² − 5/3 is a factor; 3(x² − 5/3) = 3x² − 5 [1]",
      "Divide 3x⁴ + 6x³ − 2x² − 10x − 5 by (3x² − 5) to get x² + 2x + 1 = (x+1)² [1]",
      "All zeroes: √(5/3), −√(5/3), −1, −1 [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "Zeroes in AP: α = a−d, β = a, γ = a+d; Sum = 3a = 12 ⟹ a = 4, so β = 4 [1]",
      "αβ + βγ + γα = (4−d)(4) + 4(4+d) + (4−d)(4+d) = 16−4d+16+4d+16−d² = 48−d²; 48 − d² = 44 ⟹ d² = 4 ⟹ d = ±2 [1]",
      "Zeroes: 2, 4, 6 (or 6, 4, 2); c = −αβγ = −(2)(4)(6) = −48 [1]",
    ],
    finalAnswer: "c = −48",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  },
{
    ...
    solutionSteps: [
      "Factor from known zeroes: [x − (2+√3)][x − (2−√3)] = x² − 4x + 1 [1]",
      "Divide 2x⁴ − 9x³ + 5x² + 3x − 1 by (x² − 4x + 1) [1]",
      "Quotient = 2x² − x − 1 = (2x + 1)(x − 1) [1]",
      "Remaining zeroes: x = −1/2 and x = 1 [1]",
      "All zeroes: 2+√3, 2−√3, 1, −1/2 [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "α + β = −b/a, αβ = c/a; New sum = 1/(α+1) + 1/(β+1) = (α+β+2)/((α+1)(β+1)) [1]",
      "(α+1)(β+1) = αβ + α + β + 1 = c/a − b/a + 1 = (a − b + c)/a; New sum = (−b/a + 2)/((a−b+c)/a) = (2a − b)/(a − b + c) [1]",
      "New product = 1/((α+1)(β+1)) = a/(a − b + c); Polynomial: (a−b+c)x² − (2a−b)x + a [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "The polynomial is x² − px − p − c = x² − px − (p+c). [1]",
      "Sum of zeroes α+β = p. Product of zeroes αβ = -(p+c). [1]",
      "(α+1)(β+1) = αβ + α + β + 1 = -(p+c) + p + 1 = -p - c + p + 1 = 1 - c. [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "Dividend = Divisor × Quotient + Remainder; x³ − 3x² + x + 2 = g(x)(x − 2) + (−2x + 4) [1]",
      "g(x)(x − 2) = x³ − 3x² + x + 2 + 2x − 4 = x³ − 3x² + 3x − 2; Note x = 2: 8 − 12 + 6 − 2 = 0, so (x−2) divides x³ − 3x² + 3x − 2 [1]",
      "g(x) = (x³ − 3x² + 3x − 2)/(x − 2) = x² − x + 1 [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "(i) 6x² + x − 2 = (2x − 1)(3x + 2) [1]",
      "(ii) x = 3: length = 2(3)−1 = 5, breadth = 3(3)+2 = 11, area = 55 [1]",
      "(iii) Zeroes: x = 1/2 and x = −2/3 [1]",
      "(iv) A(x) > 0 when x > 1/2 or x < −2/3 (practically x > 1/2 since dimensions must be positive) [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "p(x) = k(x − 3)(x − 1/2)(x + 1) [1]",
      "Take k = 2 for integer coefficients: 2(x−3)(x−1/2)(x+1) = (x−3)(2x−1)(x+1) [1]",
      "= (x−3)(2x²+x−1) = 2x³+x²−x−6x²−3x+3 = 2x³ − 5x² − 4x + 3 [1]",
    ],
  ...
  },
{
    ...
    solutionSteps: [
      "Let zeroes be a−d, a, a+d; Sum = 3a = 15/2, so a = 5/2; Sum of products taken two at a time: a(a−d) + a(a+d) + (a−d)(a+d) = 37/2 [1]",
      "a² − ad + a² + ad + a² − d² = 37/2; 3a² − d² = 37/2 [1]",
      "3(25/4) − d² = 37/2 → 75/4 − d² = 74/4 → d² = 1/4 → d = 1/2; Zeroes: 2, 5/2, 3 [1]",
    ],
    finalAnswer: "2, 5/2, 3",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  },
{
    ...
    solutionSteps: [
      "For 2x² − 5x + 4, α+β = -(-5)/2 = 5/2 and αβ = 4/2 = 2. [1]",
      "α² + β² = (α+β)² - 2αβ. [1]",
      "α² + β² = (5/2)² - 2(2) = 25/4 - 4 = (25 - 16)/4 = 9/4. [1]",
    ],
    answer: "9/4",
    finalAnswer: "α² + β² = 9/4",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  },
{
    ...
    solutionSteps: [
      "If zeroes are 1, -1, 2, -2, then factors are (x-1), (x+1), (x-2), (x+2). [1]",
      "P(x) = (x-1)(x+1)(x-2)(x+2) = (x²-1)(x²-4). [1]",
      "P(x) = x⁴ - 4x² - x² + 4 = x⁴ - 5x² + 4. [1]",
    ],
    finalAnswer: "x⁴ − 5x² + 4",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  },
{
    ...
    solutionSteps: [
      "α + β = −5/2, αβ = k/2; α² + β² + αβ = (α+β)² − 2αβ + αβ = (α+β)² − αβ [1]",
      "25/4 − k/2 = 21/4 [1]",
      "k/2 = 25/4 − 21/4 = 1 ⟹ k = 2 [1]",
      "2x² + 5x + 2 = (2x + 1)(x + 2) [1]",
      "Zeroes: −1/2 and −2 [1]",
    ],
...
{ id: "POLY-AR05", subject: "Maths", topicKey: "Polynomials", subtopic: "Relationship between Zeroes and Coefficients", section: "A", marks: 1, format: "Assertion-Reasoning", difficulty: "Medium", bloomSkill: "Analysing", questionText: "Assertion (A): A quadratic polynomial can have at most 2 zeroes.\nReason (R): The degree of a polynomial determines the maximum number of zeroes it can have.", options: ["Both A and R are true, and R is the correct explanation of A.", "Both A and R are true, but R is not the correct explanation of A.", "A is true, R is false.", "A is false, R is true."], answer: "Both A and R are true, and R is the correct explanation of A.", explanation: "Both the Assertion and the Reason are correct statements. The Reason directly explains the scientific/mathematical basis that makes the Assertion true, so R is the correct explanation of A.", finalAnswer: "Both A and R are true, and R is the correct explanation of A.", isCompetencyBased: true,
  ...
  }  ,
  {
    ...
    solutionSteps: [
      "Since √3 and −√3 are zeroes, (x − √3)(x + √3) = x² − 3 is a factor.; Divide 2x³ + x² − 6x − 3 by x² − 3: quotient = 2x + 1 [½]",
      "Third zero: 2x + 1 = 0 ⟹ x = −1/2 [½]",
      "All zeroes: √3, −√3, −1/2 [1]",
    ],
    finalAnswer: "√3, −√3, −1/2",
    visualExplainerId: "maths-polynomials-zeroes-of-a-polynomial", isCompetencyBased: true,
  },
