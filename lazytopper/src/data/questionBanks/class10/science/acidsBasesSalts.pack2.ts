...
export const ABS2_PACK2: CanonicalQuestion[] = [
  ...
  },
  {
    ...
    "solutionSteps": [
      "Base: a compound that produces OH⁻ ions in water and turns red litmus blue. Example: NaOH.",
      "Salt: the ionic compound formed when an acid neutralises a base. Example: NaCl."
    ],
