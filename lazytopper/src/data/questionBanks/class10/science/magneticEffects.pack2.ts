...
export const ME2_PACK2: CanonicalQuestion[] = [
  ...
  },
  {
    ...
    "solutionSteps": [
      "Diagram: Draw the electric motor (or generator) showing the rectangular coil ABCD between the poles of a magnet, commutator (motor) or slip rings (generator), carbon brushes, and external circuit.",
  ...
  },
  {
    ...
    "visualExplainerId": "science-magnetic-effects-electromagnet-and-solenoid",
    "isCompetencyBased": true,
    "pyqYear": "2019",
    "pyqSet": "Delhi",
    "ncertRef": "NCERT Ch13 InText"
  ...
  },
  {
    ...
    "visualExplainerId": "science-magnetic-effects-magnetic-field-lines",
    "isCompetencyBased": true,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch13 InText"
  ...
  },
  {
    ...
    "visualExplainerId": "science-magnetic-effects-flemings-left-hand-rule",
    "isCompetencyBased": true,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch13 Exercise"
...

  {
    ...
    "difficulty": "Easy",
    "bloomSkill": "Remembering",
    "questionText": "What is an electromagnet?",
    "options": ["A permanent magnet","A coil with iron core that becomes magnetic when current flows","A magnet made of steel","A non-magnetic material"],
    "answer": "A coil with iron core that becomes magnetic when current flows",
    "solutionSteps": ["Electromagnet: solenoid with soft iron core; magnetic when current flows, demagnetises when current stops"],
    "finalAnswer": "A coil with iron core that becomes magnetic when current flows",
    "explanation": "Electromagnet = solenoid with iron core; magnetic when current flows.",
    "isCompetencyBased": false,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch13"
  },
  {
    ...
    "difficulty": "Easy",
    "bloomSkill": "Remembering",
    "questionText": "Generating electric current by a changing magnetic field is called:",
    "options": ["Electrolysis","Electromagnetic induction","Photoelectric effect","Galvanisation"],
    "answer": "Electromagnetic induction",
    "solutionSteps": ["Electromagnetic induction: changing magnetic flux induces EMF — Faraday's law"],
    "finalAnswer": "Electromagnetic induction",
    "explanation": "Changing magnetic flux induces EMF = electromagnetic induction.",
    "isCompetencyBased": false,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch13"
  },
  {
    ...
    "difficulty": "Medium",
    "bloomSkill": "Analysing",
    "questionText": "Assertion (A): A current-carrying conductor in a magnetic field experiences a force.\nReason (R): The interaction between the conductor's magnetic field and the external field causes a force (motor effect).",
    ...
    "answer": "Both A and R are true, and R is the correct explanation of A.",
    "solutionSteps": ["A: true — current in magnetic field experiences force (Fleming's left-hand rule)","R: true — field interaction causes force","R explains A"],
    "finalAnswer": "Both A and R are true, and R is the correct explanation of A.",
    "explanation": "Field interaction (R) causes force on current conductor (A) — motor principle.",
    "isCompetencyBased": true,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT"
  ...
  },
  {
    ...
    "options": ["Magnetic effect of current","Electromagnetic induction","Electrolysis","Heating effect of current"],
    "answer": "Electromagnetic induction",
    "solutionSteps": ["Generator converts mechanical to electrical energy using electromagnetic induction (rotating coil in magnetic field)"],
    "finalAnswer": "Electromagnetic induction",
    "explanation": "Generator works on electromagnetic induction.",
    "isCompetencyBased": false,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch13"
