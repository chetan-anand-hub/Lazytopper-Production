...
export const ELECTRICITY_SQP: CanonicalQuestion[] = [
  {
    ...
    "answer": "R₁ : R = 1 : 9.",
    "solutionSteps": [
      "[1 mark] Resistance of each cut part = R/3 (resistance ∝ length when cross-section and material are unchanged).",
      "[1 mark] Parallel combination of three (R/3) resistors: 1/R₁ = 3/R + 3/R + 3/R = 9/R ⇒ R₁ = R/9. Hence R₁ : R = 1 : 9."
    ],
  ...
  },
  {
    ...
    "solutionSteps": [
      "[1 mark] (i) Joule's law of heating: the heat dissipated across a resistor is directly proportional to (a) the square of the current flowing through it, (b) the resistance of the conductor, and (c) the duration for which the current flows. Mathematically H = I²Rt.",
      "[1.5 marks] (ii) Resistance of a conductor depends on: (a) length of the conductor (R ∝ L), (b) cross-sectional area (R ∝ 1/A), (c) the nature of the material (resistivity ρ), and (d) temperature of the conductor (R generally increases with T for metals).",
      "[0.5 mark] Any two factors fetch full marks for part (ii)."
    ],
  ...
  },
  {
    ...
    "solutionSteps": [
      "[0.5 mark] (i) Anannya's answer is incorrect. Three-pin plugs are not used to reduce heating in connecting wires.",
  ...
  },
  {
    ...
    "solutionSteps": [
      "[1 mark] Part (i): At Position 2, only the 12 Ω lamps (headlights) are on. At Position 3, only the 4 Ω lamps (sidelights) are on. The selector switch chooses which pair the battery feeds.",
      "[1 mark] Part (ii): All lamps in each set are connected in parallel across the 12 V battery, so each lit lamp has the full supply voltage — V = 12 V across each lamp.",
      "[0.5 mark] Part (iii)(a): For each 12 Ω lamp (Position 2), V = IR ⇒ I = V/R = 12/12 = 1 A.",
      "[0.5 mark] Part (iii)(b): For each 4 Ω lamp (Position 3), I = V/R = 12/4 = 3 A.",
      "[1 mark] OR (alternative): P = V²/R with V = 12 V for both. For each 4 Ω lamp: P = (12)²/4 = 144/4 = 36 W. For each 12 Ω lamp: P = (12)²/12 = 144/12 = 12 W. So the 4 Ω lamp has the higher power (36 W > 12 W)."
    ],
