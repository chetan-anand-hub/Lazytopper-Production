...
export const METALS_NON_METALS_APQ: CanonicalQuestion[] = [
  ...
  { id: "APQ-S-METAL-001", subject: "Science", topicKey: "metals-and-non-metals", subtopic: "Corrosion — Galvanisation", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Understanding",
    ...
    answer: "only Q and R",
    solutionSteps: ["[0.5 mark] Q correct: zinc coating blocks air/moisture from iron surface.", "[0.5 mark] R correct: zinc is more reactive than iron (sacrificial anode), so it corrodes preferentially. P false: oxidation still occurs but on zinc, not iron."],
  ...
  { id: "APQ-S-METAL-002", subject: "Science", topicKey: "metals-and-non-metals", subtopic: "Electrolytic Refining", section: "A", marks: 1, format: "MCQ", difficulty: "Easy", bloomSkill: "Remembering",
    ...
    solutionSteps: ["[1 mark] At cathode (negative electrode): reduction occurs. Metal ions (Mn+) accept electrons from the electrode to deposit as neutral metal atoms (M)."],
  ...
  { id: "APQ-S-METAL-003", subject: "Science", topicKey: "metals-and-non-metals", subtopic: "Reactivity Series — Tarnishing", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Applying",
    ...
    answer: "sodium",
    solutionSteps: ["[1 mark] Sodium is the most reactive among the four (highest in reactivity series). It rapidly reacts with O2 and moisture in air, forming a dull oxide layer fastest. (Sodium is stored under kerosene to prevent this.)"],
  ...
  { id: "APQ-S-METAL-004", subject: "Science", topicKey: "metals-and-non-metals", subtopic: "Reduction of Zinc Oxide", section: "A", marks: 1, format: "Assertion-Reasoning", difficulty: "Medium", bloomSkill: "Analysing",
    ...
    solutionSteps: ["[0.5 mark] A is true: ZnO + C → Zn + CO (carbon reduces ZnO to Zn at high temperature).", "[0.5 mark] R is false: carbon is MORE reactive than zinc in the reactivity context — that's why it can reduce ZnO."],
  ...
  { id: "APQ-S-METAL-005", subject: "Science", topicKey: "metals-and-non-metals", subtopic: "Reactive Metal Storage", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Remembering",
    ...
    solutionSteps: ["[1 mark] (a) Balanced equation: 4 K + O2 → 2 K2O. Storing under kerosene blocks contact with air.", "[1 mark] (b) The prevented reaction is a combination reaction (also classified as oxidation)."],
  ...
  { id: "APQ-S-METAL-007", subject: "Science", topicKey: "metals-and-non-metals", subtopic: "Electronic Configuration — Ionic Compounds", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1 mark] Ionic compounds form between metals (low valence electrons: Q has 1, T has 2) and non-metals (high valence electrons: R has 6, U has 7).", "[1 mark] (a) Valid pairs: Q & R, Q & U, T & R, T & U.", "[1 mark] (b) Formulas: Q loses 1 e- → Q+; R gains 2 e- → R^2- ⟹ Q2R. T loses 2 e- → T^2+; U gains 1 e- → U- ⟹ TU2."],
  ...
  { id: "APQ-S-METAL-008", subject: "Science", topicKey: "metals-and-non-metals", subtopic: "Reactivity Series — Photolytic Decomposition", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1.5 marks] (a) Bottom section. Metals at the bottom (e.g., Ag) are least reactive — their compounds are unstable and decompose easily even by sunlight, releasing the free metal.", "[1.5 marks] (b) Photolytic decomposition: e.g., 2 AgCl → 2 Ag + Cl2 (in sunlight)."],
  ...
  { id: "APQ-S-METAL-011", subject: "Science", topicKey: "metals-and-non-metals", subtopic: "Electrorefining of Copper", section: "A", marks: 1, format: "Assertion-Reasoning", difficulty: "Medium", bloomSkill: "Analysing",
    ...
    answer: "A is true but R is false.",
    solutionSteps: ["[0.5 mark] A is true: In electrorefining, the impure copper anode dissolves into solution as Cu^2+ ions, which then migrate to and deposit on the pure copper cathode.", "[0.5 mark] R is false: Reduction (gain of electrons) occurs at the CATHODE, not the anode. At the anode oxidation occurs (Cu → Cu^2+ + 2 e-). So R is incorrect."],
    finalAnswer: "(c) A is true but R is false.",
  ...
  { id: "APQ-S-METAL-013", subject: "Science", topicKey: "metals-and-non-metals", subtopic: "Amphoteric Oxides — Aluminium and Thermite", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[1 mark] A = Aluminium (used as reducing agent in thermite reaction). On heating with O2: 4 Al + 3 O2 → 2 Al2O3, so B = Al2O3 — an amphoteric oxide.", "[1 mark] Reaction of Al2O3 (basic side) with acid HCl: Al2O3 + 6 HCl → 2 AlCl3 + 3 H2O.", "[1 mark] Reaction of Al2O3 (acidic side) with base NaOH: Al2O3 + 2 NaOH → 2 NaAlO2 + H2O (sodium aluminate)."],
  ...
  { id: "APQ-S-METAL-014", subject: "Science", topicKey: "metals-and-non-metals", subtopic: "Electrolytic Reduction of Sodium Chloride; Thermite", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1 mark] (a) Carbon cannot reduce oxides of highly reactive metals (Na, Mg, Ca, Al) because these metals have greater affinity for oxygen than carbon does. So carbon cannot strip oxygen away from their oxides.", "[1 mark] (b) Electrolytic reduction of molten NaCl: at CATHODE (reduction): Na+ + e- → Na (sodium deposited). At ANODE (oxidation): 2 Cl- → Cl2 + 2 e- (chlorine gas evolved).", "[1 mark] (c) Reduction of manganese dioxide with aluminium powder (thermite-type reaction): 3 MnO2(s) + 4 Al(s) → 3 Mn(l) + 2 Al2O3(s) + Heat (highly exothermic)."],
