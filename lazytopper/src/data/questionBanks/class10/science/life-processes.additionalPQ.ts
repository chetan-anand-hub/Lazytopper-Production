...
export const LIFE_PROCESSES_APQ: CanonicalQuestion[] = [
  ...
  { id: "APQ-S-LIFE-012", subject: "Science", topicKey: "life-processes", subtopic: "Heart Anatomy — Chambers and Vessels", section: "E", marks: 4, format: "Case-Based", difficulty: "Medium", bloomSkill: "Understanding",
    ...
    solutionSteps: ["(a) Chamber 7 = RIGHT VENTRICLE pumps deoxygenated blood to the lungs through the PULMONARY ARTERIES.", "(b) Structure 12 = valve(s). Function: ensure that blood does not flow backwards when the atria or ventricles contract.", "(c) Chambers 6 and 7 = LEFT and RIGHT VENTRICLES. Chambers 8 and 9 = LEFT and RIGHT ATRIA. Ventricles have thicker walls because they must pump blood out of the heart at high pressure to reach all parts of the body, while atria only push blood into the ventricles."],
  ...
  { id: "APQ-S-LIFE-013", subject: "Science", topicKey: "life-processes", subtopic: "Heart — Oxygenated Blood Inlet and Septum Significance", section: "E", marks: 4, format: "Case-Based", difficulty: "Medium", bloomSkill: "Understanding",
    ...
    solutionSteps: ["(i) Oxygen-rich blood from the lungs returns to the heart via the PULMONARY VEINS and enters the LEFT ATRIUM (chamber 8).", "(ii) The septum (wall) separating the right and left sides of the heart prevents mixing of oxygenated blood (left side) and deoxygenated blood (right side). This ensures the body receives fully oxygenated blood, supporting high metabolic rates."],
