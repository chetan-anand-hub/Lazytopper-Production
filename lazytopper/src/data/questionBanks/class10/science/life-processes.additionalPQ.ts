...
export const LIFE_PROCESSES_APQ: CanonicalQuestion[] = [
  ...
  { id: "APQ-S-LIFE-001", subject: "Science", topicKey: "life-processes", subtopic: "Water Uptake in Plants — Osmosis", section: "A", marks: 1, format: "MCQ", difficulty: "Easy", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[0.5 mark] Water moves from soil (lower solute concentration) to root cell sap (higher solute) across selectively permeable membranes — this is osmosis, not diffusion.", "[0.5 mark] Roots take up water even at night (via root pressure), and water flow is unidirectional (root → leaves)."],
  ...
  { id: "APQ-S-LIFE-003", subject: "Science", topicKey: "life-processes", subtopic: "Digestion — Pancreas Function", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1 mark] Pancreas secretes lipase (digests fats) along with amylase, trypsin. If pancreas malfunctions, fat digestion is impaired ⟹ low-fat diet recommended."],
  ...
  { id: "APQ-S-LIFE-005", subject: "Science", topicKey: "life-processes", subtopic: "Excretion — Nephron Function", section: "B", marks: 2, format: "Short", difficulty: "Medium", bloomSkill: "Analysing",
    ...
    solutionSteps: ["[1 mark] Filtration: normally large proteins are too big to pass through the glomerular filter. If filtration becomes leaky, proteins enter the filtrate.", "[1 mark] Selective reabsorption: even if small amounts pass through, they're normally reabsorbed back into blood. If reabsorption fails, proteins remain in urine ⟹ proteinuria."],
  ...
  { id: "APQ-S-LIFE-006", subject: "Science", topicKey: "life-processes", subtopic: "Digestion — Role of HCl in Stomach", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[0.5 mark] HCl creates an acidic medium needed to activate pepsin (the inactive pepsinogen → active pepsin), the enzyme that digests proteins.", "[0.5 mark] Carbohydrate / starch digestion (salivary amylase) and lipid digestion (pancreatic lipase + bile) occur in mouth and small intestine respectively, and do not depend on stomach HCl."],
  ...
  { id: "APQ-S-LIFE-007", subject: "Science", topicKey: "life-processes", subtopic: "Peristalsis in Alimentary Canal", section: "A", marks: 1, format: "MCQ", difficulty: "Easy", bloomSkill: "Remembering",
    ...
    answer: "Peristalsis",
    solutionSteps: ["[0.5 mark] Peristalsis is the rhythmic, wave-like contraction of smooth muscles lining the alimentary canal that pushes food forward.", "[0.5 mark] Translocation = movement of food in plants; transpiration = water loss from leaves; autotrophism = self-feeding mode of plants."],
  ...
  { id: "APQ-S-LIFE-008", subject: "Science", topicKey: "life-processes", subtopic: "Gas Exchange in Lungs — Alveoli and Blood", section: "A", marks: 1, format: "MCQ", difficulty: "Medium", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[0.5 mark] In the lungs, gaseous exchange occurs across the thin alveolar wall: CO2 diffuses from blood (in pulmonary capillaries) into the alveoli; O2 diffuses from alveoli into blood.", "[0.5 mark] Tissue-fluid–blood exchange occurs at body tissues (systemic capillaries), not in the lungs."],
  ...
  { id: "APQ-S-LIFE-009", subject: "Science", topicKey: "life-processes", subtopic: "Mineral Ion Uptake by Roots — Active Transport", section: "A", marks: 1, format: "Assertion-Reasoning", difficulty: "Medium", bloomSkill: "Analysing",
    ...
    solutionSteps: ["[0.5 mark] A is true: the ion concentration in xylem (after active uptake) differs significantly from that of surrounding soil.", "[0.5 mark] R is true and EXPLAINS A: root cells actively transport (against gradient) mineral ions from soil into xylem, creating the concentration difference observed."],
  ...
  { id: "APQ-S-LIFE-011", subject: "Science", topicKey: "life-processes", subtopic: "Transportation — Four-Chambered Heart Advantage", section: "B", marks: 2, format: "Short", difficulty: "Medium", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[1 mark] A four-chambered heart keeps oxygenated and deoxygenated blood completely SEPARATE, preventing mixing.", "[1 mark] This enables a highly EFFICIENT supply of oxygen-rich blood to all body parts — essential for animals with high energy demands such as birds and mammals (which must maintain a constant body temperature)."],
