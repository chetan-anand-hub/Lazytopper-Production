...
export const EL2_PACK2: CanonicalQuestion[] = [
...

  {
    ...
    "difficulty": "Easy",
    "bloomSkill": "Remembering",
    "questionText": "Which statement best describes Ohm's law?",
    "options": ["V = IR^2","Voltage is directly proportional to current at constant temperature","Current is inversely proportional to voltage","Resistance depends on current"],
    "answer": "Voltage is directly proportional to current at constant temperature",
    "solutionSteps": ["Ohm's law: V = IR; at constant temperature V is directly proportional to I"],
    "finalAnswer": "Voltage is directly proportional to current at constant temperature",
    "explanation": "Ohm's law: V=IR; V proportional to I at constant T.",
    "isCompetencyBased": false,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch12"
  },
  {
    ...
    "answer": "Ohm",
    "solutionSteps": ["Resistance measured in ohms (O); 1 O = 1 V/A"],
    "finalAnswer": "Ohm",
    "explanation": "Resistance is measured in ohm (O).",
    "isCompetencyBased": false,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch12"
  },
  {
    ...
    "difficulty": "Easy",
    "bloomSkill": "Remembering",
    "questionText": "Three resistors 2 O, 3 O, 6 O in parallel. Equivalent resistance is:",
    "options": ["11 O","1 O","6 O","0.5 O"],
    "answer": "1 O",
    "solutionSteps": ["1/R = 1/2 + 1/3 + 1/6 = 3/6 + 2/6 + 1/6 = 1; R = 1 O"],
    "finalAnswer": "1 O",
    "explanation": "1/R = 1/2+1/3+1/6 = 1; R = 1 O.",
    "isCompetencyBased": false,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch12"
  },
  {
    ...
    "options": ["Joule","Coulomb","Watt","Kilowatt-hour"],
    "answer": "Watt",
    "solutionSteps": ["Power = Voltage x Current = VI; unit is watt (W) = joule per second"],
    "finalAnswer": "Watt",
    "explanation": "Power = VI; unit = watt (W).",
    "isCompetencyBased": false,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch12"
  },
  {
    ...
    "difficulty": "Medium",
    "bloomSkill": "Analysing",
    "questionText": "Assertion (A): Resistors in series have a greater equivalent resistance than any individual resistor.\nReason (R): In series connection, R_total = R1 + R2 + R3 — all resistances add up.",
    ...
    "answer": "Both A and R are true, and R is the correct explanation of A.",
    "solutionSteps": ["A: true — series equivalent > individual resistors","R: true — series formula directly explains this"],
    "finalAnswer": "Both A and R are true, and R is the correct explanation of A.",
    "explanation": "Series: R total = sum (R) explains why total > individual (A).",
    "isCompetencyBased": true,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT"
  },
  {
    ...
    "difficulty": "Easy",
    "bloomSkill": "Remembering",
    "questionText": "The commercial unit of electrical energy is:",
    "options": ["Watt","Joule","Kilowatt-hour","Volt"],
    "answer": "Kilowatt-hour",
    "solutionSteps": ["1 kWh = 3.6 x 10^6 J; used for billing household electricity"],
    "finalAnswer": "Kilowatt-hour",
    "explanation": "Commercial unit of energy = kilowatt-hour (kWh).",
    "isCompetencyBased": false,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch12"
  },
  {
    ...
    "difficulty": "Easy",
    "bloomSkill": "Remembering",
    "questionText": "A bulb has resistance 100 O. Current flowing is 2 A. What is the voltage across it?",
    "options": ["50 V","100 V","200 V","20 V"],
    "answer": "200 V",
    "solutionSteps": ["V = IR = 2 x 100 = 200 V"],
    "finalAnswer": "200 V",
    "explanation": "V = IR = 2 x 100 = 200 V.",
    "isCompetencyBased": false,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch12"
  },
  {
    ...
    "difficulty": "Hard",
    "bloomSkill": "Analysing",
    "questionText": "A household uses: a 100 W bulb for 5 hours, an 800 W iron for 1 hour, and a 2000 W geyser for 0.5 hours per day. (i) Calculate the energy consumed by each appliance in kWh per day. (ii) Calculate the total monthly bill at Rs 5 per unit (30 days).",
    "options": undefined,
    "answer": "(i) Bulb: 0.5 kWh, Iron: 0.8 kWh, Geyser: 1.0 kWh/day; (ii) Rs 345",
