...
export const LIFE_CFPQ: CanonicalQuestion[] = [
  ...
  // pdf-page 47 (folio 46) — Q11 [2]. Rubric row 11: pdf-page 54.
  {
    ...
    solutionSteps: [
      ...
      "[1 mark] (b) beta cells OR cells of the pancreas; (c) Balance of life processes would be disturbed in the human body.",
    ],
    finalAnswer:
  ...
  // pdf-page 48 (folio 47) — Q13 [2]. Rubric row 13: pdf-pages 54-55.
  {
    ...
    solutionSteps: [
      "[0.5 mark] (a) involuntary",
      "[0.5 mark] (b) reflex arc",
