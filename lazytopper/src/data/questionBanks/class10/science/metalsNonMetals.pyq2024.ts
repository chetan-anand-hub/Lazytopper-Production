...
export const metalsNonMetalsPYQ2024: CanonicalQuestion[] = [
  ...
  { id: "PYQ-S-2024-METAL-002", subject: "Science", topicKey: "magnetic-effects-of-electric-current", subtopic: "Magnetic Field Lines", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    questionText: "A student fixes a sheet of white paper on a drawing board. He places a bar magnet in the centre of it. He sprinkles some iron filings uniformly around the bar magnet. Then he taps the drawing board gently and observes that the iron filings arrange themselves in a particular pattern. (a) Why do iron filings arrange in a particular pattern ? (b) What does the crowding of iron filings at the ends of the magnet indicate ? (c) What do the lines, along which the iron filings align, represent ? (d) If the student places a cardboard horizontally in a current carrying solenoid and repeats the above activity, in what pattern would the iron filings arrange ? State the conclusion drawn about the magnetic field based on the observed pattern of the lines.",
    answer: "(a) A magnetic field exists around the bar magnet. (b) The field is strongest near the poles. (c) The lines represent the magnetic field lines. (d) Equidistant parallel lines; the magnetic field inside the solenoid is uniform.",
    solutionSteps: ["[1 mark] (a) Because a magnetic field exists around the bar magnet", "[1 mark] (b) Strength of the magnetic field is maximum near the poles of the magnet", "[1 mark] (c) The lines represent the magnetic field lines. (d) Equidistant parallel lines; the magnetic field inside the solenoid is uniform."],
    finalAnswer: "(a) A magnetic field exists around the bar magnet. (b) The field is strongest near the poles. (c) The lines represent the magnetic field lines. (d) Equidistant parallel lines; the magnetic field inside the solenoid is uniform.",
    ncertRef: "PYQ 31/4/1 Q32", isCompetencyBased: true,
