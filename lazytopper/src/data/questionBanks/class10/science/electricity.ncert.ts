...
export const ELEC_NCERT: CanonicalQuestion[] = [
  ...
  { id: "ELEC-NCERT-11-SA-001", subject: "Science", topicKey: "electricity", subtopic: "Electric Circuit", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Remembering",
    ...
    solutionSteps: ["[1 mark] An electric circuit is a continuous and closed conducting path of an electric current.", "[0.5 mark] It comprises a source of potential difference (cell/battery), connecting wires, a switch (plug key) and electrical components.", "[0.5 mark] Current flows only when the path is closed; opening the switch breaks the circuit and stops the current."],
  ...
  { id: "ELEC-NCERT-11-SA-002", subject: "Science", topicKey: "electricity", subtopic: "Unit of Current", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Remembering",
    ...
    solutionSteps: ["[1 mark] The SI unit of current is the ampere (A), named after Andre-Marie Ampere.", "[0.5 mark] One ampere = rate of flow of one coulomb of charge per second.", "[0.5 mark] Symbolically, 1 A = 1 C s⁻¹."],
  ...
  { id: "ELEC-NCERT-11-SA-003", subject: "Science", topicKey: "electricity", subtopic: "Charge & Electrons", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Charge on one electron, e = 1.6 × 10⁻¹⁹ C.", "[0.5 mark] If n electrons make up a charge Q, then Q = n × e ⇒ n = Q/e.", "[0.5 mark] For Q = 1 C: n = 1 / (1.6 × 10⁻¹⁹) = 6.25 × 10¹⁸.", "[0.5 mark] Hence about 6.25 × 10¹⁸ electrons constitute one coulomb of charge."],
  ...
  { id: "ELEC-NCERT-11-SA-004", subject: "Science", topicKey: "electricity", subtopic: "Current & Charge", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Given: current I = 0.5 A, time t = 10 min = 600 s.", "[0.5 mark] Using the definition of current, I = Q/t ⇒ Q = I × t.", "[0.5 mark] Substituting: Q = 0.5 A × 600 s = 300 C.", "[0.5 mark] Hence the charge flowing through the circuit is 300 coulombs."],
    finalAnswer: "Q = 300 C",
  ...
  { id: "ELEC-NCERT-11-SA-005", subject: "Science", topicKey: "electricity", subtopic: "Potential Difference", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Remembering",
    ...
    solutionSteps: ["[1 mark] A cell (or battery) maintains a potential difference across its terminals.", "[0.5 mark] Chemical energy inside the cell is converted to electrical energy.", "[0.5 mark] When connected to a conductor, this potential difference drives the current."],
  ...
  { id: "ELEC-NCERT-11-SA-006", subject: "Science", topicKey: "electricity", subtopic: "Volt Definition", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[1 mark] Potential difference V between two points = work done per unit charge moved between the points: V = W/Q.", "[0.5 mark] If V = 1 volt, then 1 joule of work is done to move 1 coulomb of charge between the points.", "[0.5 mark] Hence 1 V = 1 J C⁻¹."],
  ...
  { id: "ELEC-NCERT-11-SA-007", subject: "Science", topicKey: "electricity", subtopic: "Energy and Voltage", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] By definition, V = W/Q, where W is work (energy) done per charge Q.", "[1 mark] For Q = 1 C and V = 6 V, W = V × Q = 6 V × 1 C = 6 J.", "[0.5 mark] Hence each coulomb of charge gains 6 J of energy passing through the 6 V battery."],
  ...
  { id: "ELEC-NCERT-11-SA-008", subject: "Science", topicKey: "electricity", subtopic: "Work and Voltage", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Given: charge Q = 2 C, potential difference V = 12 V.", "[0.5 mark] Work done in moving a charge through a potential difference: W = V × Q.", "[0.5 mark] Substituting: W = 12 V × 2 C = 24 J.", "[0.5 mark] Hence the work done is 24 joules."],
    finalAnswer: "W = 24 J",
  ...
  { id: "ELEC-NCERT-11-SA-009", subject: "Science", topicKey: "electricity", subtopic: "Factors Affecting Resistance", section: "C", marks: 3, format: "Short", difficulty: "Easy", bloomSkill: "Remembering",
    ...
    solutionSteps: ["[1 mark] Resistance is directly proportional to the length of the conductor: R ∝ l.", "[1 mark] Resistance is inversely proportional to the area of cross-section: R ∝ 1/A.", "[0.5 mark] Resistance depends on the nature of the material through its resistivity ρ.", "[0.5 mark] Combining: R = ρl/A. Resistance also varies with temperature."],
  ...
  { id: "ELEC-NCERT-11-SA-010", subject: "Science", topicKey: "electricity", subtopic: "Resistance and Thickness", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[0.5 mark] For a given material and length, R = ρl/A, so R is inversely proportional to area of cross-section.", "[0.5 mark] Thicker wire ⇒ larger A ⇒ smaller R.", "[0.5 mark] By Ohm's law, I = V/R; smaller R at the same V gives larger I.", "[0.5 mark] Hence current flows more easily through the thick wire."],
  ...
  { id: "ELEC-NCERT-11-SA-011", subject: "Science", topicKey: "electricity", subtopic: "Ohm's Law Application", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Ohm's law: I = V/R. Here R remains constant.", "[0.5 mark] New potential difference V' = V/2.", "[0.5 mark] New current I' = V'/R = (V/2)/R = (1/2)(V/R) = I/2.", "[0.5 mark] Hence the current through the component reduces to half of its initial value."],
  ...
  { id: "ELEC-NCERT-11-SA-012", subject: "Science", topicKey: "electricity", subtopic: "Alloys in Heating Devices", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[1 mark] Resistivity of an alloy is generally much higher than that of pure metals ⇒ more heat generated per unit length for the same current.", "[0.5 mark] Alloys do not oxidise readily even at high temperatures, so the heating element has a long life.", "[0.5 mark] Alloys have high melting points, so the coil can be heated red-hot without melting."],
  ...
  { id: "ELEC-NCERT-11-SA-013", subject: "Science", topicKey: "electricity", subtopic: "Resistivity Comparison", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[0.5 mark] A material with lower resistivity (ρ) is a better conductor.", "[0.5 mark] ρ(iron) = 10.0 × 10⁻⁸ Ω m; ρ(mercury) = 94.0 × 10⁻⁸ Ω m. Iron has the lower ρ, so iron is the better conductor.", "[0.5 mark] From the table, silver has the lowest ρ = 1.60 × 10⁻⁸ Ω m.", "[0.5 mark] Hence silver is the best conductor among the listed materials."],
  ...
  { id: "ELEC-NCERT-11-SA-014", subject: "Science", topicKey: "electricity", subtopic: "Ohm's Law Calculation", section: "C", marks: 3, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Using Ohm's law: I = V/R.", "[1 mark] (a) V = 220 V, R = 1200 Ω ⇒ I = 220/1200 = 0.183 A ≈ 0.18 A.", "[1 mark] (b) V = 220 V, R = 100 Ω ⇒ I = 220/100 = 2.2 A.", "[0.5 mark] Note: at the same voltage, a lower-resistance device (heater) draws more current than a higher-resistance device (bulb)."],
  ...
  { id: "ELEC-NCERT-11-SA-015", subject: "Science", topicKey: "electricity", subtopic: "Ohm's Law Calculation", section: "C", marks: 3, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1 mark] Given: V₁ = 60 V, I₁ = 4 A. Find resistance R = V₁/I₁ = 60/4 = 15 Ω.", "[0.5 mark] Now V₂ = 120 V and R remains the same.", "[1 mark] By Ohm's law, I₂ = V₂/R = 120/15 = 8 A.", "[0.5 mark] Hence the heater will draw a current of 8 A."],
    finalAnswer: "I₂ = 8 A",
  ...
  { id: "ELEC-NCERT-11-LA-001", subject: "Science", topicKey: "electricity", subtopic: "Resistivity Calculation", section: "D", marks: 5, format: "Long", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1 mark] Given: R = 26 Ω, l = 1 m, diameter d = 0.3 mm = 3 × 10⁻⁴ m.", "[1 mark] Area of cross-section A = πd²/4 = π × (3 × 10⁻⁴)² / 4 = π × 9 × 10⁻⁸ / 4 ≈ 7.07 × 10⁻⁸ m².", "[1 mark] Using R = ρl/A, the resistivity is ρ = RA/l.", "[1 mark] ρ = (26 × 7.07 × 10⁻⁸) / 1 ≈ 1.84 × 10⁻⁶ Ω m.", "[1 mark] From Table 11.2, ρ = 1.84 × 10⁻⁶ Ω m corresponds to manganese."],
  ...
  { id: "ELEC-NCERT-11-SA-016", subject: "Science", topicKey: "electricity", subtopic: "Resistance Scaling", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] For a wire of the same material, R = ρl/A.", "[0.5 mark] First wire: R₁ = ρl/A = 4 Ω.", "[1 mark] Second wire: R₂ = ρ × (l/2) / (2A) = (1/4) × ρl/A = R₁/4.", "[1 mark] Hence R₂ = 4/4 = 1 Ω."],
    finalAnswer: "R₂ = 1 Ω",
  ...
  { id: "ELEC-NCERT-11-SA-018", subject: "Science", topicKey: "electricity", subtopic: "Parallel Resistance Limit", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] In parallel: 1/R_p = Σ (1/Rᵢ). Therefore R_p is less than the smallest resistance in the combination.", "[1 mark] (a) 1/R_p = 1 + 10⁻⁶ ≈ 1 ⇒ R_p ≈ 1 Ω (very slightly less than 1 Ω).", "[1 mark] (b) 1/R_p = 1 + 10⁻³ + 10⁻⁶ ≈ 1.001 ⇒ R_p ≈ 0.999 Ω ≈ 1 Ω.", "[0.5 mark] Conclusion: when a small resistor is in parallel with much larger resistors, the equivalent resistance is essentially equal to the smallest resistance."],
  ...
  { id: "ELEC-NCERT-11-LA-004", subject: "Science", topicKey: "electricity", subtopic: "Parallel Combination", section: "D", marks: 5, format: "Long", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1 mark] For parallel resistors: 1/R_p = 1/R₁ + 1/R₂ + 1/R₃ = 1/100 + 1/50 + 1/500.", "[1 mark] Take LCM 500: 1/R_p = 5/500 + 10/500 + 1/500 = 16/500.", "[1 mark] R_p = 500/16 = 31.25 Ω.", "[1 mark] Total current drawn: I = V/R_p = 220 / 31.25 = 7.04 A.", "[1 mark] Iron must draw the same current at 220 V, so R_iron = V/I = 220/7.04 ≈ 31.25 Ω."],
  ...
  { id: "ELEC-NCERT-11-SA-019", subject: "Science", topicKey: "electricity", subtopic: "Parallel Advantage", section: "C", marks: 3, format: "Short", difficulty: "Easy", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[1 mark] In parallel, each device gets the same (full) supply voltage and operates at its rated power.", "[0.5 mark] Each branch carries the current required by its device; devices with very different resistances/ratings can coexist.", "[1 mark] If one device is switched off or fails, the others in other branches continue to function (the circuit is not broken).", "[0.5 mark] The total resistance is lower than any single device, so more current can be supplied to drive multiple appliances."],
  ...
  { id: "ELEC-NCERT-11-LA-005", subject: "Science", topicKey: "electricity", subtopic: "Mixed Combinations", section: "D", marks: 5, format: "Long", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1.5 marks] (a) To get 4 Ω: combine 3 Ω and 6 Ω in parallel first. 1/R' = 1/3 + 1/6 = 2/6 + 1/6 = 3/6 = 1/2, so R' = 2 Ω.", "[1 mark] Then put the 2 Ω resistor in series with R'(= 2 Ω): R_total = 2 + 2 = 4 Ω.", "[0.5 mark] (b) To get 1 Ω: connect all three resistors in parallel.", "[1 mark] 1/R = 1/2 + 1/3 + 1/6 = 3/6 + 2/6 + 1/6 = 6/6 = 1.", "[1 mark] Therefore R = 1 Ω."],
  ...
  { id: "ELEC-NCERT-11-SA-020", subject: "Science", topicKey: "electricity", subtopic: "Extremes of Combination", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1.5 marks] Maximum resistance: connect all coils in series. R_max = R₁ + R₂ + R₃ + R₄ = 4 + 8 + 12 + 24 = 48 Ω.", "[0.5 mark] Minimum resistance: connect all coils in parallel.", "[0.5 mark] 1/R_min = 1/4 + 1/8 + 1/12 + 1/24. With LCM 24: = 6/24 + 3/24 + 2/24 + 1/24 = 12/24 = 1/2.", "[0.5 mark] R_min = 2 Ω."],
  ...
  { id: "ELEC-NCERT-11-SA-021", subject: "Science", topicKey: "electricity", subtopic: "Heating Effect", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[0.5 mark] The cord (copper, low resistivity) and the heating element (nichrome, high resistivity) carry the same current I in series.", "[0.5 mark] By Joule's law H = I²Rt, the heat produced is proportional to resistance for the same I and t.", "[0.5 mark] The element has a high resistance, so most of the heat is dissipated there and it becomes red-hot and glows.", "[0.5 mark] The cord has a very low resistance, so very little heat is produced and it remains cool and does not glow."],
  ...
  { id: "ELEC-NCERT-11-SA-022", subject: "Science", topicKey: "electricity", subtopic: "Heat Energy", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Given: Q = 96000 C, V = 50 V, t = 1 h (time is not needed for the energy calculation here).", "[0.5 mark] Energy transferred = work done = V × Q.", "[1.5 marks] H = V × Q = 50 V × 96000 C = 4,800,000 J = 4.8 × 10⁶ J.", "[0.5 mark] Hence the heat generated is 4.8 × 10⁶ joules."],
  ...
  { id: "ELEC-NCERT-11-SA-023", subject: "Science", topicKey: "electricity", subtopic: "Joule's Heating", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Given: R = 20 Ω, I = 5 A, t = 30 s.", "[0.5 mark] Joule's law of heating: H = I²Rt.", "[0.5 mark] H = (5)² × 20 × 30 = 25 × 20 × 30 = 15,000 J.", "[0.5 mark] Hence H = 1.5 × 10⁴ J."],
  ...
  { id: "ELEC-NCERT-11-LA-008", subject: "Science", topicKey: "electricity", subtopic: "Power and Resistance", section: "D", marks: 5, format: "Long", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1 mark] Power input P = V × I, so current I = P/V; resistance R = V/I.", "[1 mark] Case (a): P = 840 W, V = 220 V. I = 840/220 = 3.82 A.", "[1 mark] R = V/I = 220 / 3.82 ≈ 57.60 Ω.", "[1 mark] Case (b): P = 360 W, V = 220 V. I = 360/220 = 1.64 A.", "[1 mark] R = 220 / 1.64 ≈ 134.15 Ω."],
  ...
  { id: "ELEC-NCERT-11-SA-024", subject: "Science", topicKey: "electricity", subtopic: "Heat from Resistor", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Given H = 100 J in t = 1 s through R = 4 Ω.", "[1 mark] Using H = I²Rt ⇒ I² = H/(Rt) = 100/(4 × 1) = 25.", "[0.5 mark] Therefore I = √25 = 5 A.", "[1 mark] Applying Ohm's law: V = IR = 5 × 4 = 20 V."],
    finalAnswer: "V = 20 V",
  ...
  { id: "ELEC-NCERT-11-SA-025", subject: "Science", topicKey: "electricity", subtopic: "Electric Power", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Remembering",
    ...
    solutionSteps: ["[0.5 mark] Rate of energy delivery = electric power P.", "[0.5 mark] P = V × I (work done per unit time per unit charge × charge per second).", "[0.5 mark] Equivalently, using Ohm's law, P = I²R = V²/R.", "[0.5 mark] Thus the rate is determined by the potential difference and the current (or by R for a given V)."],
  ...
  { id: "ELEC-NCERT-11-SA-026", subject: "Science", topicKey: "electricity", subtopic: "Bulb Power", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Given V = 220 V, I = 0.50 A.", "[0.5 mark] Electric power P = V × I.", "[1 mark] P = 220 × 0.50 = 110 W = 110 J/s."],
    finalAnswer: "P = 110 W",
  ...
  { id: "ELEC-NCERT-11-SA-027", subject: "Science", topicKey: "electricity", subtopic: "Voltmeter Connection", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Remembering",
    ...
    solutionSteps: ["[0.5 mark] A voltmeter measures the potential difference across two points.", "[1 mark] It must be connected in parallel across the two points.", "[0.5 mark] An ideal voltmeter has very high resistance so it draws negligible current and does not disturb the circuit."],
  ...
  { id: "ELEC-NCERT-11-LA-011", subject: "Science", topicKey: "electricity", subtopic: "Resistance and Geometry", section: "D", marks: 5, format: "Long", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Given d = 0.5 mm = 5 × 10⁻⁴ m, ρ = 1.6 × 10⁻⁸ Ω m, R = 10 Ω.", "[1 mark] Area A = πd²/4 = π × (5 × 10⁻⁴)² / 4 = π × 25 × 10⁻⁸ / 4 ≈ 1.963 × 10⁻⁷ m².", "[1.5 marks] From R = ρl/A: l = RA/ρ = (10 × 1.963 × 10⁻⁷) / (1.6 × 10⁻⁸) = (1.963 × 10⁻⁶) / (1.6 × 10⁻⁸) ≈ 122.7 m.", "[1 mark] If diameter is doubled, new area = π(2d)²/4 = 4A. So new resistance R' = ρl/(4A) = R/4.", "[1 mark] Hence the resistance becomes 10/4 = 2.5 Ω (reduces to one-fourth)."],
  ...
  { id: "ELEC-NCERT-11-SA-028", subject: "Science", topicKey: "electricity", subtopic: "Ohm's Law", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Given V = 12 V and I = 2.5 mA = 2.5 × 10⁻³ A.", "[0.5 mark] Using Ohm's law: R = V/I.", "[1 mark] R = 12 / (2.5 × 10⁻³) = 4800 Ω = 4.8 kΩ."],
  ...
  { id: "ELEC-NCERT-11-SA-029", subject: "Science", topicKey: "electricity", subtopic: "Series Circuit", section: "C", marks: 3, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] For series resistors, R_total = sum of resistances.", "[1 mark] R_total = 0.2 + 0.3 + 0.4 + 0.5 + 12 = 13.4 Ω.", "[1 mark] In a series circuit the current is the same in every resistor: I = V/R_total = 9 / 13.4 ≈ 0.67 A.", "[0.5 mark] Hence the current through the 12 Ω resistor is also ≈ 0.67 A."],
  ...
  { id: "ELEC-NCERT-11-SA-030", subject: "Science", topicKey: "electricity", subtopic: "Parallel Resistors Count", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1 mark] Current through one 176 Ω resistor at 220 V: I₀ = V/R = 220/176 = 1.25 A.", "[0.5 mark] All resistors are in parallel, so total current = n × I₀.", "[1 mark] Set n × 1.25 = 5 ⇒ n = 5 / 1.25 = 4.", "[0.5 mark] Hence 4 resistors of 176 Ω each are needed in parallel."],
  ...
  { id: "ELEC-NCERT-11-LA-013", subject: "Science", topicKey: "electricity", subtopic: "Mixed Combinations", section: "D", marks: 5, format: "Long", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1 mark] (i) Combine two 6 Ω resistors in parallel: 1/R' = 1/6 + 1/6 = 2/6 ⇒ R' = 3 Ω.", "[1.5 marks] Place the third 6 Ω in series with R': total = 6 + 3 = 9 Ω. ✓", "[1 mark] (ii) Combine two 6 Ω resistors in series: R'' = 6 + 6 = 12 Ω.", "[1 mark] Put the third 6 Ω in parallel with R'': 1/R = 1/12 + 1/6 = 1/12 + 2/12 = 3/12 = 1/4.", "[0.5 mark] Therefore R = 4 Ω. ✓"],
  ...
  { id: "ELEC-NCERT-11-SA-031", subject: "Science", topicKey: "electricity", subtopic: "Number of Bulbs", section: "C", marks: 3, format: "Short", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1 mark] Current drawn by one bulb: I₀ = P/V = 10 W / 220 V = 1/22 A ≈ 0.0455 A.", "[0.5 mark] All bulbs are in parallel, so total current = n × I₀.", "[1 mark] Set n × (1/22) ≤ 5 ⇒ n ≤ 110.", "[0.5 mark] Therefore at most 110 bulbs of 10 W can be connected in parallel without exceeding 5 A."],
  ...
  { id: "ELEC-NCERT-11-LA-014", subject: "Science", topicKey: "electricity", subtopic: "Hot-plate Coils", section: "D", marks: 5, format: "Long", difficulty: "Medium", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1.5 marks] Case (a) — one coil only: R = 24 Ω. I = V/R = 220 / 24 = 9.17 A.", "[1.5 marks] Case (b) — series combination: R_s = 24 + 24 = 48 Ω. I = 220 / 48 ≈ 4.58 A.", "[1 mark] Case (c) — parallel combination: 1/R_p = 1/24 + 1/24 = 2/24 ⇒ R_p = 12 Ω.", "[0.5 mark] I = 220 / 12 ≈ 18.33 A.", "[0.5 mark] Summary: single ≈ 9.17 A; series ≈ 4.58 A; parallel ≈ 18.33 A."],
  ...
  { id: "ELEC-NCERT-11-LA-015", subject: "Science", topicKey: "electricity", subtopic: "Power Comparison", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Analysing",
    ...
    solutionSteps: ["[1 mark] Case (i): 1 Ω and 2 Ω in series with 6 V battery. R_total = 1 + 2 = 3 Ω.", "[1.5 marks] Current I = V/R = 6 / 3 = 2 A. Power dissipated in 2 Ω: P₁ = I²R = (2)² × 2 = 8 W.", "[0.5 mark] Case (ii): 12 Ω and 2 Ω each connected directly to the 4 V battery (parallel).", "[1.5 marks] Voltage across the 2 Ω resistor = 4 V. Power in 2 Ω: P₂ = V²/R = (4)² / 2 = 16/2 = 8 W.", "[0.5 mark] Therefore P₁ = P₂ = 8 W; the ratio is 1 : 1."],
  ...
  { id: "ELEC-NCERT-11-SA-032", subject: "Science", topicKey: "electricity", subtopic: "Parallel Lamps", section: "C", marks: 3, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Each lamp gets the full supply voltage of 220 V (parallel connection).", "[1 mark] Current in 100 W lamp: I₁ = P₁/V = 100 / 220 = 5/11 A ≈ 0.455 A.", "[1 mark] Current in 60 W lamp: I₂ = P₂/V = 60 / 220 = 3/11 A ≈ 0.273 A.", "[0.5 mark] Total line current I = I₁ + I₂ = (100 + 60)/220 = 160/220 = 8/11 A ≈ 0.73 A."],
  ...
  { id: "ELEC-NCERT-11-SA-033", subject: "Science", topicKey: "electricity", subtopic: "Energy Comparison", section: "C", marks: 3, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Energy consumed = power × time (with consistent units).", "[1 mark] TV: P = 250 W, t = 1 h ⇒ Energy = 250 × 1 = 250 Wh.", "[1 mark] Toaster: P = 1200 W, t = 10 min = 1/6 h ⇒ Energy = 1200 × 1/6 = 200 Wh.", "[0.5 mark] Compare: 250 Wh > 200 Wh, so the TV uses more energy."],
  ...
  { id: "ELEC-NCERT-11-SA-034", subject: "Science", topicKey: "electricity", subtopic: "Rate of Heating", section: "B", marks: 2, format: "Short", difficulty: "Easy", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] Rate of heating = electric power P = I²R.", "[0.5 mark] Given I = 15 A, R = 8 Ω.", "[0.5 mark] P = (15)² × 8 = 225 × 8 = 1800 W = 1.8 kW.", "[0.5 mark] Hence heat is developed at the rate of 1800 J s⁻¹."],
  ...
  { id: "ELEC-NCERT-11-LA-016", subject: "Science", topicKey: "electricity", subtopic: "Conceptual Explanations", section: "D", marks: 5, format: "Long", difficulty: "Medium", bloomSkill: "Understanding",
    ...
    solutionSteps: ["[1 mark] (a) Tungsten's very high melting point (~3380 °C) lets its filament become red-hot/white-hot without melting; it emits enough light when hot.", "[1 mark] (b) Alloys (e.g., nichrome) have high resistivity (more I²R heat per metre) and do not oxidise at high temperature, giving long-lasting heating elements.", "[1 mark] (c) Series: same current through every device, so devices needing different currents can't all run; failure of one breaks the entire circuit; voltage divides across devices instead of full mains being available.", "[1 mark] (d) R = ρl/A, so R is inversely proportional to area A. Doubling A halves R; quadrupling A reduces R to one-fourth.", "[1 mark] (e) Copper and aluminium have very low resistivity (≈10⁻⁸ Ω m), so transmission losses (I²R) are small; they are also ductile, abundant and economical."],
