...
export const electricityPYQ2024: CanonicalQuestion[] = [
  ...
  { id: "PYQ-S-2024-ELEC-002", subject: "Science", topicKey: "electricity", subtopic: "General", section: "E", marks: 4, format: "Case-Based", difficulty: "Hard", bloomSkill: "Analysing",
    questionText: "Study the following circuit : On the basis of this circuit, answer the following questions : (a) Find the value of total resistance between the points A and B. (b) Find the resistance between the points B and C. (c) (i) Calculate the current drawn from the battery, when the key is closed. 2 OR (c) (ii) In the above circuit, the 16 resistor or the parallel combination of two resistors of 8 , which one of the two will have more potential difference across its two ends ? Justify your answer.",
    answer: "Ohm's law when same current flows, the potential difference across a higher resistance is always higher./ Potential difference across 16 Ω =V=IR = 0.2x16=3.2V Potential difference across 8 Ω =V=IR(total) = 0.2x4 =0.8V",
    solutionSteps: ["(a) Rs = 4 Ω + 6 Ω + 16 Ω = 26 Ω (b) 1 𝑅𝑃= 1 8 𝛺+ 1 8 𝛺= 1 4 𝛺 Rp = 4 Ω (c) (i) Total resistance = 26 Ω + 4 Ω = 30 Ω Potential difference = V = 6V Current I = 𝑉 𝑅 6 30 = 1 5 𝐴 or 0⋅2 A.", "OR (c)(ii) 16 Ω Justification", "According to", "Ohm's law when same current flows, the potential difference across a higher resistance is always higher./ Potential difference across 16 Ω =V=IR = 0.2x16=3.2V Potential difference across 8 Ω =V=IR(total) = 0.2x4 =0.8V"],
    finalAnswer: "Ohm's law when same current flows, the potential difference across a higher resistance is always higher./ Potential difference across 16 Ω =V=IR = 0.2x16=3.2V Potential difference across 8 Ω =V=IR(total) = 0.2x4 =0.8V",
