...
export const HOW_DO_ORGANISMS_REPRODUCE_APQ: CanonicalQuestion[] = [
  ...
  { id: "APQ-S-REPR-003", subject: "Science", topicKey: "how-do-organisms-reproduce", subtopic: "Asexual Reproduction + Functional Anatomy", section: "D", marks: 5, format: "Long", difficulty: "Hard", bloomSkill: "Analysing",
    ...
    solutionSteps: ["[1 mark] (a) Regeneration: in some multicellular organisms (e.g. Planaria, Hydra) the cells of a body fragment divide and differentiate to rebuild all the missing body parts — similar to the way stem cells act.", "[1 mark] (a) Budding: a small outgrowth (bud) develops on the parent body (e.g. Hydra); its cells divide and differentiate into all the required tissues, and the bud then detaches as a new individual — also stem-cell-like.", "[1 mark] (b) Testes (male) and Ovaries (female) are a functionally similar pair — both produce gametes and secrete reproductive hormones (testosterone / oestrogen).", "[1 mark] (b) Vas deferens (male) and Fallopian tube / oviduct (female) are a functionally similar pair — both are ducts that transport the gametes towards the site of fertilisation.", "[1 mark] Justification: in each pair the two organs perform the same reproductive function in the two sexes, which is why they are described as functionally analogous."],
