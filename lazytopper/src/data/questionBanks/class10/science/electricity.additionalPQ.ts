...
export const ELECTRICITY_APQ: CanonicalQuestion[] = [
  ...
  { id: "APQ-S-ELEC-001", subject: "Science", topicKey: "electricity", subtopic: "Ohm's Law and Ammeter Selection", section: "B", marks: 2, format: "Short", difficulty: "Hard", bloomSkill: "Applying",
    ...
    solutionSteps: ["[0.5 mark] R2 and R3 in parallel: (8 × 4)/(8 + 4) = 32/12 = 2.67 Ω.", "[1 mark] Net R = R1 + parallel = 2 + 2.67 = 4.66 Ω. Current I = V/R = 12/4.66 ≈ 2.58 A.", "[0.5 mark] P, Q, R have max < 2.58 A. Only ammeter S (range 0-10 A) covers this current."],
  ...
  { id: "APQ-S-ELEC-002", subject: "Science", topicKey: "electricity", subtopic: "Power, Energy, Series Circuits", section: "C", marks: 3, format: "Short", difficulty: "Hard", bloomSkill: "Applying",
    ...
    solutionSteps: ["[1.5 marks] (a) Power P = V^2/R = 240^2/100 = 576 W. Energy = P × t = 576 W × (4 h × 7 days × 3600 s) = 576 × 100800 = 58,060,800 J = 58,060.8 kJ.", "[1 mark] (b) Series: Rnet = 100 + 100 = 200 Ω. Total power Ptot = V^2/Rnet = 240^2/200 = 288 W. Each bulb gets half: PA' = 144 W (since identical bulbs share equally).", "[0.5 mark] Compare: PA' = 144 W < PA = 576 W ⟹ bulb A glows DIMMER in series."],
