...
const GENERIC_MAGNETIC_FIELD: DiagramSpec = {
  ...
  caption: "Field lines go from N-pole to S-pole outside the magnet. Use right-hand thumb rule for conductors.",
  points: [
    { id: "N", x: 140, y: 120, label: "N" },
    { id: "S", x: 280, y: 120, label: "S" },
    { id: "Top1", x: 210, y: 50, label: "" },
    { id: "Bot1", x: 210, y: 190, label: "" },
    { id: "Top2", x: 210, y: 30, label: "" },
    { id: "Bot2", x: 210, y: 210, label: "" },
    { id: "RuleLabel", x: 210, y: 235, label: "B: N \u2192 S (outside)" },
  ],
  edges: [
    { from: "N", to: "S", highlight: true },
    { from: "N", to: "Top1", dashed: true },
    { from: "Top1", to: "S", dashed: true },
    { from: "N", to: "Bot1", dashed: true },
    { from: "Bot1", to: "S", dashed: true },
    { from: "N", to: "Top2", dashed: true },
    { from: "Top2", to: "S", dashed: true },
    { from: "N", to: "Bot2", dashed: true },
    { from: "Bot2", to: "S", dashed: true },
  ],
};
...
const GENERIC_RAY_DIAGRAM: DiagramSpec = {
  ...
  width: 420,
  height: 240,
  title: "Ray Diagram (Convex Lens)",
  caption: "Object beyond 2F forms real, inverted, diminished image between F and 2F on other side. Remember: real images form below principal axis.",
  points: [
...
const GENERIC_MENSURATION_SOLID: DiagramSpec = {
  ...
  width: 420,
  height: 240,
  title: "Mensuration — Solid with Dimensions",
  caption: "Label r, h, l and apply: Volume = (1/3)πr²h for cone, (4/3)πr³ for sphere. TSA = CSA + base areas.",
  points: [
