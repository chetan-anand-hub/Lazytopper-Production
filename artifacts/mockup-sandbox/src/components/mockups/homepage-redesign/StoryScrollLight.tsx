...
export function StoryScrollLight() {
  const containerRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    if (!document.getElementById("story-scroll-light-fonts")) {
      const link = document.createElement("link");
      link.id = "story-scroll-light-fonts";
      link.rel = "stylesheet";
  ...
  return (
    ...
    >
      <style dangerouslySetInnerHTML={{__html: `
        .font-display-lt { font-family: 'Nunito', sans-serif; }
        .card-shadow { box-shadow: 0 4px 24px -4px rgba(0,0,0,0.06), 0 0 4px rgba(0,0,0,0.02); }
        .section-h-lt { min-height: 100vh; display: flex; flex-direction: column; justify-content: center; }
      ...
      {/* 1. HERO SECTION */}
      <section className="section-h-lt relative px-6 md:px-12 py-20 items-center justify-center text-center bg-white overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-[70%] bg-gradient-to-b from-[#e6f9e0] to-white pointer-events-none"></div>
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-3/4 h-3/4 bg-[#58cc02]/5 blur-[120px] rounded-full pointer-events-none"></div>

        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#e6f9e0] border border-[#58cc02]/20 mb-8">
          ...
          <h1 className="font-display-lt text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[1.1] mb-10 text-[#3c3c3c]">
          ...
          <div className="mt-12 flex flex-col items-center gap-3">
            <div className="flex -space-x-3">
              {[1,2,3,4].map(i => (
                <div key={i} className="w-10 h-10 rounded-full border-2 border-white bg-[#f7f7f7] flex items-center justify-center overflow-hidden shadow-sm">
          ...
          <div className="mt-6 flex items-center gap-3 flex-wrap justify-center">
            ...
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#ddf4ff] border border-[#1cb0f6]/30">
      ...
      <section className="section-h-lt relative px-6 md:px-12 py-24 bg-[#f7f7f7]">
        <div className="max-w-6xl mx-auto w-full flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            <h2 className="font-display-lt text-4xl md:text-6xl font-black mb-6 text-[#3c3c3c]">See the future. <br/><span className="text-[#58cc02]">Study the trends.</span></h2>
          </div>

          <div className="lg:w-1/2 w-full">
            <div className="bg-white rounded-3xl p-6 md:p-8 relative card-shadow border border-[#e5e5e5]">
              ...
              <div className="flex justify-between items-end mb-8 border-b border-[#e5e5e5] pb-4">
                <div>
                  <h3 className="font-display-lt text-2xl font-bold text-[#3c3c3c]">Exam Predictor</h3>
      ...
      {/* 3. AI TUTOR */}
      <section className="section-h-lt relative px-6 md:px-12 py-24 bg-white">
        ...
        <div className="max-w-6xl mx-auto w-full z-10 relative flex flex-col-reverse lg:flex-row items-center gap-16">
          <div className="lg:w-1/2 w-full">
            <div className="bg-white rounded-3xl p-6 card-shadow border border-[#e5e5e5] relative overflow-hidden">
              <div className="flex items-center gap-4 border-b border-[#e5e5e5] pb-4 mb-6">
                ...
                <div>
                  <h3 className="font-display-lt font-bold text-lg text-[#3c3c3c]">Ravi Sir</h3>
          ...
          <div className="lg:w-1/2">
            <h2 className="font-display-lt text-4xl md:text-6xl font-black mb-10 leading-tight text-[#3c3c3c]">Your 24/7 <br/>personal coach.</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4 bg-[#f7f7f7] p-4 rounded-xl border border-[#e5e5e5]">
                  <div className="p-2 bg-white rounded-lg card-shadow">{feature.icon}</div>
      ...
      <section className="section-h-lt relative px-6 md:px-12 py-24 bg-[#f7f7f7]">
        <div className="max-w-6xl mx-auto w-full flex flex-col items-center">
          <h2 className="font-display-lt text-4xl md:text-6xl font-black mb-16 text-center max-w-2xl text-[#3c3c3c]">
            Don't work hard. <br/><span className="text-[#58cc02]">Work smart.</span>
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            <div className="bg-white border border-[#e5e5e5] p-8 rounded-3xl hover:border-[#ffc800]/50 transition-colors group card-shadow">
            ...
            <div className="bg-white border border-[#e5e5e5] p-8 rounded-3xl hover:border-[#ff9600]/50 transition-colors group card-shadow">
            ...
            <div className="bg-white border border-[#e5e5e5] p-8 rounded-3xl hover:border-[#1cb0f6]/50 transition-colors group card-shadow">
            ...
            <div className="bg-white border border-[#e5e5e5] p-8 rounded-3xl hover:border-[#58cc02]/50 transition-colors group card-shadow">
      ...
      <section className="section-h-lt relative px-6 md:px-12 py-24 bg-white overflow-hidden">
        <div className="max-w-6xl mx-auto w-full z-10 relative flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            <h2 className="font-display-lt text-4xl md:text-6xl font-black mb-10 leading-tight text-[#3c3c3c]">Practice like <br/>it's the real thing.</h2>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#e6f9e0] flex items-center justify-center text-[#58cc02]">
          ...
          <div className="lg:w-1/2 w-full">
            <div className="bg-white rounded-3xl p-1 card-shadow border border-[#e5e5e5] relative">
      ...
      <section className="section-h-lt relative px-6 md:px-12 py-24 bg-[#f7f7f7]">
        <div className="max-w-6xl mx-auto w-full">
          <h2 className="font-display-lt text-4xl md:text-6xl font-black mb-16 text-center text-[#3c3c3c]">Results that speak.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white border border-[#e5e5e5] rounded-3xl p-8 relative overflow-hidden group card-shadow">
                ...
                <div className="flex items-center justify-center gap-4">
                  <div className="text-4xl font-display-lt font-bold text-[#afafaf]">{story.from}</div>
                  <ArrowRight className="w-6 h-6 text-[#58cc02]" />
                  <div className="text-6xl font-display-lt font-black text-[#58cc02]">{story.to}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* 7. FINAL CTA */}
      <section className="min-h-[70vh] flex flex-col items-center justify-center px-6 md:px-12 py-24 bg-white relative overflow-hidden">
        <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none">
          <div className="w-[600px] h-[600px] bg-[#58cc02]/8 blur-[150px] rounded-full"></div>
        </div>

        <div className="relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="font-display-lt text-5xl md:text-7xl font-black mb-10 text-[#3c3c3c]">Start free. <br/>No signup needed.</h2>
...
export default StoryScrollLight;
