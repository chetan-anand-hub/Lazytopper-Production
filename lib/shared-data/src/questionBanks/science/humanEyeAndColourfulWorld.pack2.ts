...
export const HEC2_PACK2: CanonicalQuestion[] = [
  ...
  },
  {
    ...
    "finalAnswer": "Question 1: Rajesh has presbyopia, an age-related condition in which the ciliary muscles weaken and the eye lens loses elasticity, reducing the eye's ability to accommodate for near objects; he would need a convex (converging) lens to bring near objects into focus on the retina. Question 2: Rajesh's daughter has myopia (short-sightedness), in which the image of distant objects forms in front of the retina, making them appear blurred; she would need a concave (diverging) lens to diverge the rays before they enter the eye and correct the focus. Question 3: Accommodation is the ability of the eye to change its focal length by adjusting the curvature of the lens through the action of the ciliary muscles; when viewing near objects, the ciliary muscles contract and the lens becomes thicker and more curved; in Rajesh's case, presbyopia caused by aging has weakened his ciliary muscles and reduced the flexibility of his lens, so the lens can no longer become curved enough to focus near objects on the retina.",
    "isCompetencyBased": true,
    "pyqYear": undefined,
    "pyqSet": undefined,
    "ncertRef": "NCERT Ch11 Exercise"
  },
  {
    ...
    "finalAnswer": "Question 1: Stars appear to twinkle due to atmospheric refraction; starlight enters Earth's atmosphere and passes through layers of air with continuously varying temperature, density, and refractive index; as these layers shift, the direction of the refracted starlight changes rapidly, causing the apparent position and intensity of the star as seen from the ground to fluctuate, which we perceive as twinkling. Question 2: The sun appears reddish at sunset because sunlight must travel through a much greater thickness of atmosphere near the horizon; over this long path, the shorter wavelengths of light such as violet and blue are scattered away in all directions (Rayleigh scattering), while the longer wavelengths of orange and red are scattered much less and reach the observer's eyes, giving the sun a reddish appearance. Question 3: In a rainbow, violet appears on the inner arc and red on the outer arc due to dispersion; when white light enters water droplets, it undergoes refraction and internal reflection; violet light, having the shortest wavelength, is refracted the most and exits the droplet at a smaller angle relative to the original direction, placing it on the inner arc; red light, with the longest wavelength, is refracted the least and exits at a larger angle, placing it on the outer arc.",
    "isCompetencyBased": true,
    "pyqYear": "2023",
    "pyqSet": "All India",
