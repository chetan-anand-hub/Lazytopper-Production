...
- **Parent/Teacher Dashboard:** `/parent-dashboard` page displays progress report with overall stats, weekly accuracy trend chart, topic mastery heatmap, weak areas list, and shareable link. Accessible from Profile page "Share Report" button.
...
- **Prediction Engine:** Replaced synthetic data with real CBSE Class 10 board exam pattern data (2017-2025) for Maths and Science topics. Includes fuzzy matching for subtopic lookups and calibrated NEP policy boosts reflecting post-2023 CBSE shifts.
